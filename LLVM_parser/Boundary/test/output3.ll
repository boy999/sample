...
define internal fastcc void @loop_enter() nounwind  {
entry:
	ret void
}
...
bb25.outer:		; preds = %bb29, %entry
	...
	%tmp8 = getelementptr [200 x i32]* @A, i32 0, i64 %tmp67		; <i32*> [#uses=1]
...
bb3:		; preds = %bb3, %bb25.outer
	...
	%tmp10 = add i32 %tmp9, 1		; <i32> [#uses=2]
	...
	store i32 %tmp10, i32* %tmp22, align 4
