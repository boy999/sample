...
@cg_caller_id_var = weak global i32 1		; <i32*> [#uses=8]
@cg_caller_call_site_var = weak global i32 0		; <i32*> [#uses=6]

define i32 @func(i32 %val) nounwind  {
entry:
	%val1 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 1, i32* @cg_caller_id_var
	call void @CallEdgeProfiler( i32 %val1, i32 %val2, i32 1 )
...
bb17:		; preds = %bb17.loopexit, %entry
	...
	store i32 %val1, i32* @cg_caller_id_var
	ret i32 %tmp22
}
...
bb25.outer:		; preds = %bb29, %entry
	%i.0.reg2mem.0.ph = phi i32 [ 0, %entry ], [ %indvar.next58, %bb29 ]		; <i32> [#uses=3]
