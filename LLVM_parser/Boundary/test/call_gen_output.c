...
static void CallEdgeProfiler(unsigned int llvm_cbe_functionId, unsigned int llvm_cbe_callSiteId);
...
static unsigned int func(unsigned int llvm_cbe_val);
...
static unsigned char __PRETTY_FUNCTION___2E_2596[17];
...
static unsigned char __PRETTY_FUNCTION___2E_2596[17] = "CallEdgeProfiler";
static struct l_struct_2E_csEdgeStruct *gCSEdgeTable;
static unsigned char _2E_str2[17] = "call_profile.log";
static unsigned char _2E_str3[2] = "w";
static unsigned char _2E_str4[6] = "%u %u";
static unsigned char _2E_str5[4] = " %u";
static unsigned long long gNumConflicts;
static unsigned long long gNumHashFind;
static unsigned int B[100];
static unsigned int A[200];
static unsigned char _2E_str6[25] = "The value of A[99] : %d\n";
static unsigned char _2E_str17[25] = "The value of B[99] : %d\n";
static bool cg_caller_id_var_2E_b;
static unsigned int cg_caller_call_site_var;
...
llvm_cbe_cond_true:
  ltmp_1_2 =  /*tail*/ malloc(((unsigned long long )336ll));
  ...
  *(&gCSEdgeTable) = (&ltmp_2_3[((signed int )((unsigned int )0))][((signed int )((unsigned int )0))]);
  ltmp_3_2 = memset((&ltmp_2_3[((signed int )((unsigned int )0))][((signed int )((unsigned int )0))].field0), (((unsigned int )(unsigned char )((unsigned char )0))), ((unsigned long long )336ll));
...
llvm_cbe_bb57:
  ...
  llvm_cbe_tmp6062 = ((unsigned long long )(unsigned int )(llvm_cbe_hashVal_0_reg2mem_0 * ((unsigned int )48)));
...
llvm_cbe_cond_next153:
  ...
  ltmp_5_2 =  /*tail*/ malloc(((((unsigned long long )(unsigned int )llvm_cbe_tmp)) * ((unsigned long long )48ll)));
  ltmp_6_1 = ((struct l_struct_2E_csEdgeStruct *)ltmp_5_2);
  llvm_cbe_tmpcast2 = &ltmp_6_1->field0;
  *(&gCSEdgeTableSize) = llvm_cbe_tmp;
  ltmp_7_2 = memset(llvm_cbe_tmpcast2, (((unsigned int )(unsigned char )((unsigned char )0))), (((unsigned long long )(unsigned int )(llvm_cbe_numElems_0 * ((unsigned int )96)))));
  if ((llvm_cbe_numElems_0 == ((unsigned int )0))) {
    goto llvm_cbe_bb312;
  } else {
...
llvm_cbe_bb187_us:
  ...
  llvm_cbe_tmp190192_us = ((unsigned long long )(unsigned int )(llvm_cbe_i176_0_reg2mem_0_us * ((unsigned int )48)));
...
llvm_cbe_cond_true203_us:
  ...
  *(&gNumHashFind) = (llvm_cbe_tmp240_us + ((unsigned long long )1ll));
  ltmp_9_2 = memcpy(((unsigned char *)/*NULL*/0), (&llvm_cbe_basePtr_0[((signed long long )llvm_cbe_tmp190192_us)]), ((unsigned long long )48ll));
  goto llvm_cbe_cond_next303_us;
...
llvm_cbe_bb187:
  ...
  llvm_cbe_tmp190192 = ((unsigned long long )(unsigned int )(llvm_cbe_i176_0_reg2mem_0 * ((unsigned int )48)));
...
llvm_cbe_bb297_loopexit:
  ...
  *(&gNumConflicts) = llvm_cbe_gNumConflicts_tmp_1;
  ltmp_10_2 = memcpy(llvm_cbe_tmp175_0_ph, llvm_cbe_tmp193, ((unsigned long long )48ll));
  goto llvm_cbe_cond_next303;
...
llvm_cbe_bb242:
  ...
  llvm_cbe_tmp245247 = ((unsigned long long )(unsigned int )(llvm_cbe_hashVal229_0_reg2mem_0 * ((unsigned int )48)));
...
llvm_cbe_bb361:
  ...
  llvm_cbe_tmp364366 = ((unsigned long long )(unsigned int )(llvm_cbe_hashVal348_0_reg2mem_0 * ((unsigned int )48)));
...
llvm_cbe_bb:
  llvm_cbe_i_0_reg2mem_0 = llvm_cbe_i_0_reg2mem_0__PHI_TEMPORARY;
  llvm_cbe_tmp19 = &llvm_cbe_tmp1314->field2[((signed long long )(((unsigned long long )(unsigned int )llvm_cbe_i_0_reg2mem_0)))];
  llvm_cbe_tmp20 = *llvm_cbe_tmp19;
  switch (llvm_cbe_tmp20) {
  default:
    goto llvm_cbe_cond_next43;
;
  case ((unsigned int )1):
    goto llvm_cbe_UnifiedReturnBlock;
  case ((unsigned int )0):
    goto llvm_cbe_cond_true36;
    break;
  }
llvm_cbe_cond_next43:
  llvm_cbe_tmp45 = llvm_cbe_i_0_reg2mem_0 + ((unsigned int )1);
  if ((((unsigned int )llvm_cbe_tmp45) < ((unsigned int )((unsigned int )8)))) {
    llvm_cbe_i_0_reg2mem_0__PHI_TEMPORARY = llvm_cbe_tmp45;   /* for PHI node */
    goto llvm_cbe_bb;
  } else {
    goto llvm_cbe_bb51;
  }
...
llvm_cbe_cond_true36:
  *llvm_cbe_tmp19 = ((unsigned int )1);
  return;
llvm_cbe_bb51:
   /*tail*/ __assert_fail((&(_2E_str[((signed long long )((unsigned long long )0ll))])), (&(_2E_str1[((signed long long )((unsigned long long )0ll))])), ((unsigned int )89), (&(__PRETTY_FUNCTION___2E_2596[((signed int )((unsigned int )0))])));
  /*UNREACHABLE*/;
llvm_cbe_UnifiedReturnBlock:
  return;
}
...
static void CallProfPrinter(void) {
  ...
  unsigned int llvm_cbe_tmp7087;
  struct l_struct_2E_csEdgeStruct *llvm_cbe_tmp390;
  unsigned char *llvm_cbe_tmp6364;
  ...
  llvm_cbe_tmp7087 = *(&gCSEdgeTableSize);
  llvm_cbe_tmp390 = *(&gCSEdgeTable);
  if ((llvm_cbe_tmp7087 == ((unsigned int )0))) {
    llvm_cbe_tmp3_reg2mem_1__PHI_TEMPORARY = llvm_cbe_tmp390;   /* for PHI node */
    goto llvm_cbe_bb75;
  } else {
...
llvm_cbe_bb_preheader:
  llvm_cbe_tmp6364 = ((unsigned char *)llvm_cbe_tmp2);
  llvm_cbe_tmp11_rle__PHI_TEMPORARY = llvm_cbe_tmp390;   /* for PHI node */
  llvm_cbe_i_0_reg2mem_0__PHI_TEMPORARY = ((unsigned int )0);   /* for PHI node */
  llvm_cbe_tmp3_reg2mem_0__PHI_TEMPORARY = llvm_cbe_tmp390;   /* for PHI node */
  goto llvm_cbe_bb;
...
llvm_cbe_bb69:
  llvm_cbe_tmp68 = llvm_cbe_i_0_reg2mem_0 + ((unsigned int )1);
  llvm_cbe_tmp70 = *(&gCSEdgeTableSize);
  llvm_cbe_tmp3 = *(&gCSEdgeTable);
  if ((((unsigned int )llvm_cbe_tmp68) < ((unsigned int )llvm_cbe_tmp70))) {
    llvm_cbe_tmp11_rle__PHI_TEMPORARY = llvm_cbe_tmp3;   /* for PHI node */
    llvm_cbe_i_0_reg2mem_0__PHI_TEMPORARY = llvm_cbe_tmp68;   /* for PHI node */
...
llvm_cbe_bb62:
  llvm_cbe_tmp65 =  /*tail*/ fputc(((unsigned int )10), llvm_cbe_tmp6364);
  goto llvm_cbe_bb69;
...
llvm_cbe_bb29:
  ...
  llvm_cbe_tmp38 = *(&llvm_cbe_tmp30[((signed long long )llvm_cbe_tmp45)].field2[((signed long long )(((unsigned long long )(unsigned int )llvm_cbe_j_0_reg2mem_0)))]);
...
llvm_cbe_cond_true42:
  llvm_cbe_tmp54 =  /*tail*/ fprintf(llvm_cbe_tmp2, (&(_2E_str5[((signed long long )((unsigned long long )0ll))])), llvm_cbe_tmp38);
  llvm_cbe_tmp56 = llvm_cbe_j_0_reg2mem_0 + ((unsigned int )1);
  if ((((unsigned int )llvm_cbe_tmp56) < ((unsigned int )((unsigned int )8)))) {
    llvm_cbe_j_0_reg2mem_0__PHI_TEMPORARY = llvm_cbe_tmp56;   /* for PHI node */
    goto llvm_cbe_bb29;
  } else {
    goto llvm_cbe_bb62;
  }
...
llvm_cbe_bb75:
  ...
  llvm_cbe_tmp79 =  /*tail*/ fclose(llvm_cbe_tmp2);
  return;
}
...
static unsigned int func(unsigned int llvm_cbe_val) {
  ...
  llvm_cbe_val1_b = *(&cg_caller_id_var_2E_b);
  llvm_cbe_val2 = *(&cg_caller_call_site_var);
  *(&cg_caller_id_var_2E_b) = ((0) & 1);
  CallEdgeProfiler((((llvm_cbe_val1_b) ? (((unsigned int )2)) : (((unsigned int )1)))), llvm_cbe_val2);
...
llvm_cbe_bb17:
  ...
  *(&cg_caller_id_var_2E_b) = ((llvm_cbe_val1_b) & 1);
...
llvm_cbe_bb25_outer:
  ...
  llvm_cbe_tmp15 = llvm_cbe_i_0_reg2mem_0_ph + ((unsigned int )1);
  llvm_cbe_tmp22 = &A[((signed long long )(((signed long long )(signed int )llvm_cbe_tmp15)))];
  llvm_cbe_j_056__PHI_TEMPORARY = ((unsigned int )0);   /* for PHI node */
  goto llvm_cbe_bb3;

llvm_cbe_bb29:
  if ((llvm_cbe_tmp15 == ((unsigned int )100))) {
    goto llvm_cbe_bb37_split;
  } else {
    llvm_cbe_i_0_reg2mem_0_ph__PHI_TEMPORARY = llvm_cbe_tmp15;   /* for PHI node */
    goto llvm_cbe_bb25_outer;
  }
...
llvm_cbe_bb37_split:
  ...
  *(&cg_caller_id_var_2E_b) = ((1) & 1);
  llvm_cbe_tmp41 =  /*tail*/ printf((&(_2E_str6[((signed long long )((unsigned long long )0ll))])), llvm_cbe_tmp39);
  llvm_cbe_tmp43 = *(&(B[((signed long long )((unsigned long long )99ll))]));
  *(&cg_caller_call_site_var) = ((unsigned int )2);
  *(&cg_caller_id_var_2E_b) = ((1) & 1);
  llvm_cbe_tmp45 =  /*tail*/ printf((&(_2E_str17[((signed long long )((unsigned long long )0ll))])), llvm_cbe_tmp43);
