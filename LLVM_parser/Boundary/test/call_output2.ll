...
@cg_caller_id_var = weak global i32 1		; <i32*> [#uses=7]
@cg_caller_call_site_var = weak global i32 0		; <i32*> [#uses=5]

define i32 @func(i32 %val) nounwind  {
entry:
	%val1 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=2]
...
bb17:		; preds = %bb17.loopexit, %entry
	...
	store i32 %val1, i32* @cg_caller_id_var, align 4
	ret i32 %tmp22
}
