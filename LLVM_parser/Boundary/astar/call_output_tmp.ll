...
@cg_caller_id_var = weak global i32 1		; <i32*> [#uses=781]
@cg_caller_call_site_var = weak global i32 0		; <i32*> [#uses=650]
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=7]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=7]
	store i32 1, i32* @cg_caller_id_var
...
cond_true21:		; preds = %cond_next21.i19, %cond_next11.i15, %cond_next, %cond_next21.i, %cond_next11.i, %entry
	...
	store i32 %val2, i32* @cg_caller_call_site_var
	store i32 %val, i32* @cg_caller_id_var
	ret i8 0
...
cond_true.i:		; preds = %cond_next75
	...
	store i32 0, i32* @cg_caller_call_site_var
	store i32 1, i32* @cg_caller_id_var
...
cond_true107.i:		; preds = %bb101.i
	store i32 1, i32* @cg_caller_call_site_var
	store i32 1, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 31, i32* @cg_caller_id_var
...
cond_false.i8:		; preds = %bb101.i
	store i32 2, i32* @cg_caller_call_site_var
	store i32 1, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 31, i32* @cg_caller_id_var
...
bb133.i:		; preds = %cond_false.i8, %cond_true107.i
	...
	store i32 %val4, i32* @cg_caller_call_site_var
	store i32 %val3, i32* @cg_caller_id_var
...
cond_next139.i:		; preds = %bb133.i, %cond_next.i
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 31, i32* @cg_caller_id_var
...
bb174.i:		; preds = %bb562.i, %cond_next90
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 32, i32* @cg_caller_id_var
...
bb549.i:		; preds = %cond_next535.i, %cond_next363.i, %cond_next350.i, %cond_next337.i, %cond_next324.i, %cond_next311.i, %cond_next298.i, %cond_next285.i, %cond_next228.i
	...
	store i32 %val42, i32* @cg_caller_call_site_var
	store i32 %val31, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 2, i32* @cg_caller_id_var
...
cond_true180:		; preds = %bb174
	...
	store i32 2, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 33, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 3, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 4, i32* @cg_caller_id_var
...
bb:		; preds = %bb166, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 34, i32* @cg_caller_id_var
...
bb112:		; preds = %cond_next145, %bb148.preheader
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 35, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 5, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 6, i32* @cg_caller_id_var
...
bb182:		; preds = %cond_next216, %bb.nph
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 36, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 7, i32* @cg_caller_id_var
...
bb:		; preds = %bb328, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 37, i32* @cg_caller_id_var
...
bb112:		; preds = %bb310, %cond_true182
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 39, i32* @cg_caller_id_var
	...
	store i32 %val44, i32* @cg_caller_call_site_var
	store i32 %val33, i32* @cg_caller_id_var
...
cond_true216:		; preds = %cond_true197
	...
	store i32 37, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 38, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 8, i32* @cg_caller_id_var
...
bb333:		; preds = %bb524, %cond_true403
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 42, i32* @cg_caller_id_var
...
cond_true436:		; preds = %cond_true418
	...
	store i32 8, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 41, i32* @cg_caller_id_var
...
cond_true548:		; preds = %bb542
	...
	store i32 8, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 40, i32* @cg_caller_id_var
...
cond_false:		; preds = %bb542
	store i32 3, i32* @cg_caller_call_site_var
	store i32 8, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 40, i32* @cg_caller_id_var
...
cond_next563:		; preds = %cond_false, %cond_true548, %bb539
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 40, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 9, i32* @cg_caller_id_var
...
bb94.i:		; preds = %cond_next.i, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 43, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 10, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 44, i32* @cg_caller_id_var
...
bb53:		; preds = %bb101.outer, %cond_next
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 47, i32* @cg_caller_id_var
...
cond_next:		; preds = %cond_true, %bb53
	...
	store i32 %val46, i32* @cg_caller_call_site_var
	store i32 %val35, i32* @cg_caller_id_var
...
bb101.outer:		; preds = %bb112, %bb109
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 46, i32* @cg_caller_id_var
...
bb121:		; preds = %cond_next189, %bb192.preheader
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 45, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 11, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 48, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 12, i32* @cg_caller_id_var
...
bb24:		; preds = %bb166, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 49, i32* @cg_caller_id_var
...
bb177:		; preds = %bb199
	...
	store i32 12, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 50, i32* @cg_caller_id_var
...
bb213:		; preds = %bb227.loopexit, %bb213
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 51, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 13, i32* @cg_caller_id_var
...
bb23:		; preds = %bb122, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 52, i32* @cg_caller_id_var
...
bb132:		; preds = %bb318.preheader, %cond_next268
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 53, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 14, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 54, i32* @cg_caller_id_var
...
bb38:		; preds = %bb142, %cond_next
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 55, i32* @cg_caller_id_var
...
bb79:		; preds = %bb79, %cond_true
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 56, i32* @cg_caller_id_var
...
bb152:		; preds = %bb219, %cond_next216
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 57, i32* @cg_caller_id_var
...
bb230:		; preds = %bb299.preheader, %cond_next296
	...
	%val39 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val410 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 59, i32* @cg_caller_id_var
...
cond_next296:		; preds = %bb272, %cond_next264, %bb230
	...
	store i32 %val410, i32* @cg_caller_call_site_var
	store i32 %val39, i32* @cg_caller_id_var
...
bb307:		; preds = %bb299.preheader, %cond_next296
	...
	store i32 %val48, i32* @cg_caller_call_site_var
	store i32 %val37, i32* @cg_caller_id_var
...
bb299.preheader:		; preds = %bb310.preheader, %bb307
	...
	%val37 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val48 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 58, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 15, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 60, i32* @cg_caller_id_var
...
bb33:		; preds = %bb56, %bb33
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 61, i32* @cg_caller_id_var
...
bb67:		; preds = %bb355, %bb.nph
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 63, i32* @cg_caller_id_var
...
bb97:		; preds = %bb347, %bb97.preheader
	...
	%val37 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val48 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 64, i32* @cg_caller_id_var
...
bb100:		; preds = %bb337, %bb97
	...
	%val39 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val410 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 65, i32* @cg_caller_id_var
...
bb135:		; preds = %bb161
	...
	store i32 %val412, i32* @cg_caller_call_site_var
	store i32 %val311, i32* @cg_caller_id_var
...
bb161:		; preds = %cond_next158, %bb161.preheader
	...
	%val311 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val412 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 66, i32* @cg_caller_id_var
...
cond_true187:		; preds = %cond_next174.critedge
	...
	store i32 15, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 62, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 63, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 64, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 16, i32* @cg_caller_id_var
...
bb127:		; preds = %cond_next176, %bb127.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 67, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 17, i32* @cg_caller_id_var
...
bb129:		; preds = %bb166, %cond_next152.i
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 70, i32* @cg_caller_id_var
...
cond_true107.i:		; preds = %cond_true88.i
	...
	store i32 17, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 69, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 70, i32* @cg_caller_id_var
...
cond_true209:		; preds = %cond_false213.critedge, %cond_true188
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 68, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 18, i32* @cg_caller_id_var
...
bb100.i:		; preds = %cond_next363.i, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 71, i32* @cg_caller_id_var
...
cond_true274.i:		; preds = %cond_next191.i
	...
	store i32 4, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 4, i32* @cg_caller_call_site_var
	store i32 71, i32* @cg_caller_id_var
...
cond_next314.i:		; preds = %cond_true274.i, %cond_next191.i
	...
	store i32 5, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 71, i32* @cg_caller_id_var
...
bb386.i:		; preds = %bb407.i
	...
	store i32 6, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 72, i32* @cg_caller_id_var
...
bb421.i:		; preds = %bb435.loopexit.i, %bb421.i
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 73, i32* @cg_caller_id_var
...
bb.i:		; preds = %bb.i, %_ZN9regmngobj13defineregionsEv.exit
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 74, i32* @cg_caller_id_var
...
bb42.i:		; preds = %bb103.preheader.i, %cond_next.i10
	...
	%val37 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val48 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 75, i32* @cg_caller_id_var
...
_ZN9regmngobj14enlargeregionsEv.exit:		; preds = %bb103.preheader.i, %cond_next.i10
	store i32 7, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	...
	store i32 8, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call void @llvm.memset.i64( i8* %tmp125126.i, i8 0, i64 %tmp122.i, i32 8 ) nounwind 
	store i32 9, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
...
bb6.i:		; preds = %bb183.preheader.i, %cond_next180.i
	...
	%val337 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val438 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 90, i32* @cg_caller_id_var
...
cond_true72.i:		; preds = %cond_true66.i
	store i32 10, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 89, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 90, i32* @cg_caller_id_var
...
cond_true107.i:		; preds = %cond_true72.i
	store i32 11, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 89, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
...
cond_next.i32:		; preds = %cond_true107.i, %cond_true72.i
	...
	store i32 12, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 89, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
cond_next180.i:		; preds = %cond_next.i32, %cond_true66.i, %cond_true.i20, %bb6.i
	...
	store i32 %val438, i32* @cg_caller_call_site_var
	store i32 %val337, i32* @cg_caller_id_var
...
bb191.i:		; preds = %bb183.preheader.i, %cond_next180.i
	...
	store i32 %val436, i32* @cg_caller_call_site_var
	store i32 %val335, i32* @cg_caller_id_var
...
bb183.preheader.i:		; preds = %bb191.i, %_ZN9regmngobj14enlargeregionsEv.exit
	...
	%val335 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val436 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 89, i32* @cg_caller_id_var
...
bb217.i:		; preds = %bb397.preheader.i, %cond_next394.i
	...
	%val333 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val434 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 88, i32* @cg_caller_id_var
...
cond_true279.i:		; preds = %cond_true245.i
	store i32 13, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 87, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 88, i32* @cg_caller_id_var
...
cond_true321.i:		; preds = %cond_true279.i
	store i32 14, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 87, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
...
cond_next323.i:		; preds = %cond_true321.i, %cond_true279.i
	...
	store i32 15, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 87, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
cond_next394.i:		; preds = %cond_next323.i, %cond_true245.i, %bb217.i
	...
	store i32 %val434, i32* @cg_caller_call_site_var
	store i32 %val333, i32* @cg_caller_id_var
...
bb405.i:		; preds = %bb397.preheader.i, %cond_next394.i
	...
	store i32 %val432, i32* @cg_caller_call_site_var
	store i32 %val331, i32* @cg_caller_id_var
...
bb397.preheader.i:		; preds = %bb405.i, %bb202.i
	...
	%val331 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val432 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 87, i32* @cg_caller_id_var
...
_ZN9regmngobj10addregionsEv.exit:		; preds = %bb405.i, %bb202.i
	...
	store i32 16, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	...
	store i32 17, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj18enlargeneighborsesEi( i32 %tmp101102 )
	store i32 18, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj19defineneighborhood1Ev( )
	...
	store i32 19, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
...
bb295.outer:		; preds = %bb306, %_ZN9regmngobj10addregionsEv.exit
	...
	%val327 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val428 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 85, i32* @cg_caller_id_var
...
bb122:		; preds = %cond_next292, %bb295.outer
	...
	%val329 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val430 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 86, i32* @cg_caller_id_var
...
cond_true184:		; preds = %cond_true150
	store i32 20, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 85, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
...
cond_true219:		; preds = %cond_true184
	store i32 21, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 85, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
...
cond_next221:		; preds = %cond_true219, %cond_true184
	...
	store i32 22, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 85, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
cond_next292:		; preds = %cond_next221, %cond_true150, %bb122
	...
	store i32 %val430, i32* @cg_caller_call_site_var
	store i32 %val329, i32* @cg_caller_id_var
...
bb306:		; preds = %cond_next292, %bb295.outer
	...
	store i32 %val428, i32* @cg_caller_call_site_var
	store i32 %val327, i32* @cg_caller_id_var
	br i1 %tmp311, label %bb314, label %bb295.outer

bb314:		; preds = %bb306, %_ZN9regmngobj10addregionsEv.exit
	store i32 23, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
...
bb386.outer:		; preds = %bb397, %bb314
	...
	%val39 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val410 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 76, i32* @cg_caller_id_var
...
bb317:		; preds = %cond_next383, %bb386.outer
	...
	%val311 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val412 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 77, i32* @cg_caller_id_var
...
cond_true379:		; preds = %cond_true345
	store i32 24, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 76, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
bb405:		; preds = %bb397, %bb314
	store i32 25, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj19defineneighborhood1Ev( )
	store i32 26, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
...
bb415:		; preds = %bb455, %bb405
	...
	%val313 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val414 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 78, i32* @cg_caller_id_var
	...
	store i32 27, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 78, i32* @cg_caller_id_var
...
bb455:		; preds = %cond_true443, %bb415
	...
	store i32 %val414, i32* @cg_caller_call_site_var
	store i32 %val313, i32* @cg_caller_id_var
...
bb465:		; preds = %bb485.preheader, %bb465
	...
	%val315 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val416 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 79, i32* @cg_caller_id_var
	...
	store i32 %val416, i32* @cg_caller_call_site_var
	store i32 %val315, i32* @cg_caller_id_var
...
bb494:		; preds = %bb485.preheader, %bb465
	...
	store i32 28, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call void @llvm.memset.i64( i8* %tmp506507, i8 0, i64 %tmp503, i32 8 )
	store i32 29, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
...
bb514:		; preds = %bb558, %bb494
	...
	%val317 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val418 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 80, i32* @cg_caller_id_var
...
bb558:		; preds = %cond_true537, %bb514
	...
	store i32 %val418, i32* @cg_caller_call_site_var
	store i32 %val317, i32* @cg_caller_id_var
	br i1 %tmp564, label %bb514, label %bb567

bb567:		; preds = %bb558, %bb494
	store i32 30, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj13deleteregionsEv( )
...
bb757.outer:		; preds = %bb768, %bb567
	...
	%val323 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val424 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 83, i32* @cg_caller_id_var
...
bb577:		; preds = %cond_next754, %bb757.outer
	...
	%val325 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val426 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 84, i32* @cg_caller_id_var
...
cond_true639:		; preds = %cond_true605
	store i32 31, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 83, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
...
cond_true681:		; preds = %cond_true639
	store i32 32, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 83, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
...
cond_next683:		; preds = %cond_true681, %cond_true639
	...
	store i32 33, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 83, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
cond_next754:		; preds = %cond_next683, %cond_true605, %bb577
	...
	store i32 %val426, i32* @cg_caller_call_site_var
	store i32 %val325, i32* @cg_caller_id_var
...
bb768:		; preds = %cond_next754, %bb757.outer
	...
	store i32 %val424, i32* @cg_caller_call_site_var
	store i32 %val323, i32* @cg_caller_id_var
	br i1 %tmp773, label %bb776, label %bb757.outer

bb776:		; preds = %bb768, %bb567
	store i32 34, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj19defineneighborhood1Ev( )
	store i32 35, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj20definemiddleregpointEv( )
...
bb787:		; preds = %bb828, %bb776
	...
	%val319 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val420 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 81, i32* @cg_caller_id_var
	...
	store i32 36, i32* @cg_caller_call_site_var
	store i32 18, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 81, i32* @cg_caller_id_var
...
bb828:		; preds = %cond_true816, %bb787
	...
	store i32 %val420, i32* @cg_caller_call_site_var
	store i32 %val319, i32* @cg_caller_id_var
...
bb838:		; preds = %bb861.preheader, %bb838
	...
	%val321 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val422 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 82, i32* @cg_caller_id_var
	...
	store i32 %val422, i32* @cg_caller_call_site_var
	store i32 %val321, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 19, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %entry
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 91, i32* @cg_caller_id_var
...
bb.i:		; preds = %bb.i, %bb29
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 92, i32* @cg_caller_id_var
...
bb203.i:		; preds = %_ZN7way2obj12releasepointEii.exit.i, %bb203.preheader.i
	...
	%val37 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val48 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 95, i32* @cg_caller_id_var
...
bb86.i.i:		; preds = %bb86.preheader.i.i, %cond_true142.i.i
	...
	%val311 = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val412 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 97, i32* @cg_caller_id_var
...
cond_true264.i.i:		; preds = %cond_true197.critedge.i.i
	...
	store i32 19, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 93, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 95, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 96, i32* @cg_caller_id_var
...
bb343.i.i:		; preds = %cond_next340.i.i, %bb343.preheader.i.i
	...
	%val39 = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val410 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 96, i32* @cg_caller_id_var
...
bb86.us.i.i:		; preds = %cond_true142.us.i.i, %bb86.us.i.i.preheader
	...
	%val313 = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val414 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 98, i32* @cg_caller_id_var
...
cond_next282.i.outer:		; preds = %bb255.i, %cond_next115.i
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 93, i32* @cg_caller_id_var
...
cond_next282.i:		; preds = %cond_next282.i.outer, %cond_true184.i
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=4]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=4]
	store i32 94, i32* @cg_caller_id_var
...
bb217.i:		; preds = %cond_next361.i, %bb.nph.i
	...
	%val317 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val418 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 100, i32* @cg_caller_id_var
...
cond_true403.i:		; preds = %bb379.i
	...
	store i32 19, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 99, i32* @cg_caller_id_var
...
cond_next496.i:		; preds = %bb489.i, %cond_next88.i
	...
	%val315 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val416 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 99, i32* @cg_caller_id_var
...
bb534.i:		; preds = %bb534.i, %bb534.preheader.i
	...
	%val319 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val420 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 101, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 20, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 21, i32* @cg_caller_id_var
...
bb:		; preds = %bb, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 102, i32* @cg_caller_id_var
...
bb258:		; preds = %bb258.preheader, %bb258
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 103, i32* @cg_caller_id_var
...
bb284:		; preds = %bb284.preheader, %bb284
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 104, i32* @cg_caller_id_var
...
bb302:		; preds = %bb302.preheader, %bb302
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 105, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=0]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=0]
	store i32 22, i32* @cg_caller_id_var
...
bb133.outer.i:		; preds = %bb144.i, %bb133.preheader.i
	...
	%val329 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val430 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 121, i32* @cg_caller_id_var
...
bb106.i:		; preds = %bb106.i, %bb106.i.preheader
	...
	%val331 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val432 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 122, i32* @cg_caller_id_var
...
cond_next.i30:		; preds = %_ZN6wayobj7loadmapEPKc.exit
	...
	store i32 37, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 38, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 39, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 40, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 41, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 42, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 43, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 44, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 45, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb.i:		; preds = %bb.i, %cond_next.i30
	...
	%val327 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val428 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 120, i32* @cg_caller_id_var
...
bb164.i:		; preds = %bb.i
	...
	store i32 46, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
_ZN9regmngobj7loadmapEPKc.exit:		; preds = %bb164.i, %_ZN6wayobj7loadmapEPKc.exit
	...
	store i32 47, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj13createregionsEi( i32 %tmp118 )
	store i32 48, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb:		; preds = %bb176, %_ZN9regmngobj7loadmapEPKc.exit
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 106, i32* @cg_caller_id_var
	...
	store i32 49, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 106, i32* @cg_caller_id_var
...
cond_true132:		; preds = %bb
	...
	store i32 50, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 106, i32* @cg_caller_id_var
...
cond_true144:		; preds = %cond_true132
	...
	store i32 51, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 106, i32* @cg_caller_id_var
...
bb183:		; preds = %bb176, %_ZN9regmngobj7loadmapEPKc.exit
	...
	store i32 52, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb186:		; preds = %bb271, %bb183
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 107, i32* @cg_caller_id_var
...
cond_next242:		; preds = %cond_next220
	...
	store i32 53, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 107, i32* @cg_caller_id_var
...
bb278:		; preds = %bb271, %bb183
	...
	store i32 54, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj7destroyEv( )
	store i32 55, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 56, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
cond_next.i580:		; preds = %bb278
	store i32 57, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 58, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 59, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 60, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 61, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 62, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 63, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 64, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb.i586:		; preds = %bb.i586, %cond_next.i580
	...
	%val325 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val426 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 119, i32* @cg_caller_id_var
...
bb110.i:		; preds = %bb.i586
	...
	store i32 65, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 66, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	%tmp174.i = call i64 @read( i32 %tmp2.i568, i8* %tmp159.i, i64 %tmp168169.i )		; <i64> [#uses=0]
	store i32 67, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb299.outer:		; preds = %bb438, %bb299.preheader
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 108, i32* @cg_caller_id_var
...
bb291:		; preds = %bb291, %bb299.outer
	...
	%val35 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val46 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 109, i32* @cg_caller_id_var
...
cond_true357:		; preds = %bb304
	...
	store i32 68, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 108, i32* @cg_caller_id_var
...
bb445:		; preds = %bb438, %_ZN7way2obj7loadmapEPKc.exit
	...
	store i32 69, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb466.outer:		; preds = %bb609, %bb466.preheader
	...
	%val37 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val48 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 110, i32* @cg_caller_id_var
...
bb458:		; preds = %bb458, %bb466.outer
	...
	%val39 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val410 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 111, i32* @cg_caller_id_var
...
cond_true528:		; preds = %bb471
	...
	store i32 70, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 110, i32* @cg_caller_id_var
...
bb.i349:		; preds = %bb.i349, %bb616
	...
	%val311 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val412 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 112, i32* @cg_caller_id_var
...
_ZN7way2obj7destroyEv.exit:		; preds = %bb.i349
	...
	store i32 91, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 92, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 93, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	...
	store i32 94, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb.i285:		; preds = %bb.i285, %_ZN7way2obj7destroyEv.exit
	...
	%val313 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val414 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 113, i32* @cg_caller_id_var
...
bb669.outer:		; preds = %bb675, %bb669.preheader
	...
	%val315 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val416 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 114, i32* @cg_caller_id_var
...
bb640:		; preds = %bb669, %cond_true647
	...
	%val319 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val420 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 116, i32* @cg_caller_id_var
...
bb669:		; preds = %cond_true.i, %cond_false, %bb669.outer
	...
	%val317 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val418 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 115, i32* @cg_caller_id_var
...
bb684:		; preds = %bb684.loopexit, %_ZN9regmngobj7initmapEii.exit
	...
	store i32 95, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	call fastcc void @_ZN9regmngobj13createregionsEi( i32 %tmp699 )
	store i32 96, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
...
bb702:		; preds = %bb765, %bb684
	...
	%val321 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val422 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 117, i32* @cg_caller_id_var
	...
	store i32 97, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 117, i32* @cg_caller_id_var
...
cond_true721:		; preds = %bb702
	...
	store i32 98, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 1, i32* @cg_caller_call_site_var
	store i32 117, i32* @cg_caller_id_var
...
cond_true733:		; preds = %cond_true721
	...
	store i32 99, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 2, i32* @cg_caller_call_site_var
	store i32 117, i32* @cg_caller_id_var
...
bb774:		; preds = %bb864, %bb772
	...
	%val323 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val424 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 118, i32* @cg_caller_id_var
...
cond_next835:		; preds = %cond_next813
	...
	store i32 100, i32* @cg_caller_call_site_var
	store i32 22, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 118, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 23, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=5]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=5]
	store i32 24, i32* @cg_caller_id_var
...
cond_true106.i:		; preds = %bb100.i
	...
	store i32 24, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
	store i32 123, i32* @cg_caller_id_var
...
bb.i:		; preds = %cond_next188.i, %bb.preheader.i
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=3]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=3]
	store i32 124, i32* @cg_caller_id_var
...
bb28.i:		; preds = %bb172.i, %bb28.preheader.i
	...
	%val33 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val44 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 125, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 25, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 26, i32* @cg_caller_id_var
...
bb:		; preds = %bb176, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 126, i32* @cg_caller_id_var
...
bb120:		; preds = %cond_next155, %bb158.preheader
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 127, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 27, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 28, i32* @cg_caller_id_var
...
bb:		; preds = %bb161, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 128, i32* @cg_caller_id_var
...
bb20:		; preds = %bb149, %bb20.preheader
	...
	%val31 = load i32* @cg_caller_id_var		; <i32> [#uses=2]
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 129, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=10]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=10]
	store i32 29, i32* @cg_caller_id_var
...
bb:		; preds = %cond_next530, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=10]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=10]
	store i32 130, i32* @cg_caller_id_var
...
entry:
	%val = load i32* @cg_caller_id_var		; <i32> [#uses=10]
	%val2 = load i32* @cg_caller_call_site_var		; <i32> [#uses=10]
	store i32 30, i32* @cg_caller_id_var
...
bb:		; preds = %bb602, %bb.preheader
	...
	%val3 = load i32* @cg_caller_id_var		; <i32> [#uses=10]
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=10]
	store i32 131, i32* @cg_caller_id_var
