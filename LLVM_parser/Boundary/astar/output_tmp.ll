...
cond_next.i:		; preds = %cond_true.i, %cond_next75
	...
	call i32 (...)* @loop_enter( i32 32 )		; <i32>:1 [#uses=0]
...
cond_next139.i:		; preds = %bb133.i, %cond_next.i
	%storemerge.in.i.rle24 = phi i16 [ %storemerge.i9, %bb133.i ], [ 1, %cond_next.i ]		; <i16> [#uses=3]
	...
	%zext = zext i16 %storemerge.in.i.rle24 to i64		; <i64> [#uses=0]
...
cond_next90:		; preds = %_ZN6wayobj4fillEiiii.exit
	...
	call i32 (...)* @loop_enter( i32 33 )		; <i32>:2 [#uses=0]
...
bb174.i:		; preds = %bb562.i, %cond_next90
	...
	%indvar.i = phi i32 [ %indvar.next.i, %bb562.i ], [ 0, %cond_next90 ]		; <i32> [#uses=3]
	%index.1.reg2mem.0.i = phi i32 [ %index.0.reg2mem.0.i, %bb562.i ], [ %tmp93.i, %cond_next90 ]		; <i32> [#uses=2]
	%zext1 = zext i32 %indvar.i to i64		; <i64> [#uses=0]
...
cond_next113:		; preds = %cond_true96, %cond_next89
	...
	call i32 (...)* @loop_enter( i32 34 )		; <i32>:1 [#uses=0]
...
cond_next212:		; preds = %bb206, %cond_next113
	%storemerge.in.rle1 = phi i16 [ %storemerge, %bb206 ], [ 1, %cond_next113 ]		; <i16> [#uses=2]
	...
	%zext = zext i16 %storemerge.in.rle1 to i64		; <i64> [#uses=0]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 35 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb166, %bb.preheader
	%j.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp165, %bb166 ]		; <i32> [#uses=3]
	%zext = zext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb148.preheader:		; preds = %bb157, %cond_true104
	...
	call i32 (...)* @loop_enter( i32 36 )		; <i32>:2 [#uses=0]
	br i1 %tmp151192, label %bb154, label %bb112

bb112:		; preds = %cond_next145, %bb148.preheader
	%indvar = phi i32 [ %indvar.next, %cond_next145 ], [ 0, %bb148.preheader ]		; <i32> [#uses=4]
	%zext2 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb.nph:		; preds = %bb219.preheader
	...
	call i32 (...)* @loop_enter( i32 37 )		; <i32>:1 [#uses=0]
	br label %bb182

bb182:		; preds = %cond_next216, %bb.nph
	%indvar = phi i32 [ 0, %bb.nph ], [ %indvar.next, %cond_next216 ]		; <i32> [#uses=3]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 39 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb328, %bb.preheader
	%j.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp327, %bb328 ]		; <i32> [#uses=3]
	%zext = zext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=0]
	%tmp15 = load %struct.pointt** %tmp14, align 8		; <%struct.pointt*> [#uses=2]
	%tmp1617 = sext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=2]
	%tmp22 = getelementptr %struct.pointt* %tmp15, i64 %tmp1617, i32 0		; <i32*> [#uses=1]
...
bb310.preheader:		; preds = %bb319, %cond_true104
	...
	call i32 (...)* @loop_enter( i32 40 )		; <i32>:2 [#uses=0]
	br label %bb310

bb112:		; preds = %bb310, %cond_true182
	%indvar = phi i32 [ %indvar.next, %cond_true182 ], [ 0, %bb310 ]		; <i32> [#uses=5]
	%zext3 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext2 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb310:		; preds = %cond_next307, %bb310.preheader
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_next307 ], [ 0, %bb310.preheader ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=1]
	%tmp313 = icmp sgt i32 %x.0, %x2.0		; <i1> [#uses=1]
	call i32 (...)* @loop_enter( i32 38 )		; <i32>:3 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 9 )		; <i32>:0 [#uses=0]
...
bb524.preheader:		; preds = %bb533, %cond_true325
	...
	call i32 (...)* @loop_enter( i32 43 )		; <i32>:1 [#uses=0]
	br label %bb524

bb333:		; preds = %bb524, %cond_true403
	%indvar = phi i32 [ %indvar.next, %cond_true403 ], [ 0, %bb524 ]		; <i32> [#uses=4]
	%zext3 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext = zext i32 %indvar to i64		; <i64> [#uses=0]
	%x.0.reg2mem.0 = add i32 %indvar, %x.0		; <i32> [#uses=6]
...
bb524:		; preds = %cond_next521, %bb524.preheader
	...
	%iter_count_phi1 = phi i64 [ %inc_iter_counter2, %cond_next521 ], [ 0, %bb524.preheader ]		; <i64> [#uses=1]
	%inc_iter_counter2 = add i64 %iter_count_phi1, 1		; <i64> [#uses=1]
	%tmp527 = icmp sgt i32 %x.0, %x2.0		; <i1> [#uses=1]
	call i32 (...)* @loop_enter( i32 42 )		; <i32>:2 [#uses=0]
...
bb539:		; preds = %bb533, %cond_true325
	...
	call i32 (...)* @loop_enter( i32 41 )		; <i32>:3 [#uses=0]
...
cond_next563:		; preds = %cond_false, %cond_true548, %bb539
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_false ], [ %inc_iter_counter, %cond_true548 ], [ 0, %bb539 ]		; <i64> [#uses=1]
...
entry:
	call i32 (...)* @func_enter( i32 10 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 44 )		; <i32>:1 [#uses=0]
	br label %bb94.i

bb94.i:		; preds = %cond_next.i, %entry
	%tmp101.rle.i = phi i32 [ 0, %entry ], [ %tmp151.i, %cond_next.i ]		; <i32> [#uses=1]
	%i.0.reg2mem.0.i = phi i32 [ 0, %entry ], [ %tmp155.i, %cond_next.i ]		; <i32> [#uses=3]
	%zext = zext i32 %i.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 11 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 47 )		; <i32>:1 [#uses=0]
	br i1 %tmp49208, label %bb, label %bb112

bb:		; preds = %bb, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp42, %bb ], [ 0, %entry ]		; <i32> [#uses=3]
	%zext = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb53:		; preds = %bb101.outer, %cond_next
	%x.0216 = phi i32 [ %tmp100, %cond_next ], [ 0, %bb101.outer ]		; <i32> [#uses=5]
	%zext4 = zext i32 %x.0216 to i64		; <i64> [#uses=0]
	%zext3 = zext i32 %x.0216 to i64		; <i64> [#uses=0]
...
bb101.outer:		; preds = %bb112, %bb109
	%y.0.reg2mem.0.ph = phi i32 [ %tmp111, %bb109 ], [ 0, %bb112 ]		; <i32> [#uses=4]
	%zext2 = zext i32 %y.0.reg2mem.0.ph to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 48 )		; <i32>:2 [#uses=0]
...
bb112:		; preds = %bb, %entry
	...
	call i32 (...)* @loop_enter( i32 45 )		; <i32>:3 [#uses=0]
...
bb192.preheader:		; preds = %bb112, %bb109
	...
	call i32 (...)* @loop_enter( i32 46 )		; <i32>:4 [#uses=0]
	br i1 %tmp198223, label %bb121, label %return

bb121:		; preds = %cond_next189, %bb192.preheader
	%i.1220 = phi i32 [ %tmp191, %cond_next189 ], [ 0, %bb192.preheader ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.1220 to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 12 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 49 )		; <i32>:1 [#uses=0]
	br i1 %tmp44101, label %bb, label %bb46

bb:		; preds = %bb, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp37, %bb ], [ 0, %entry ]		; <i32> [#uses=3]
	%zext = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 13 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 51 )		; <i32>:1 [#uses=0]
	br i1 %tmp172266, label %bb24, label %bb199.preheader

bb24:		; preds = %bb166, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp165, %bb166 ], [ 0, %entry ]		; <i32> [#uses=3]
...
bb199.preheader:		; preds = %bb166, %entry
	...
	call i32 (...)* @loop_enter( i32 50 )		; <i32>:2 [#uses=0]
	br label %bb199
...
bb199:		; preds = %bb206, %bb199.preheader, %bb177
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %bb206 ], [ 0, %bb199.preheader ], [ %inc_iter_counter, %bb177 ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=2]
...
bb213:		; preds = %bb227.loopexit, %bb213
	%i.2267 = phi i32 [ %tmp226, %bb213 ], [ 0, %bb227.loopexit ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.2267 to i64		; <i64> [#uses=0]
...
bb227.loopexit:		; preds = %bb206
	...
	call i32 (...)* @loop_enter( i32 52 )		; <i32>:3 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 14 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 53 )		; <i32>:1 [#uses=0]
	br i1 %tmp128361, label %bb23, label %bb318.preheader

bb23:		; preds = %bb122, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp121, %bb122 ], [ 0, %entry ]		; <i32> [#uses=3]
...
bb132:		; preds = %bb318.preheader, %cond_next268
	%i.1362 = phi i32 [ %tmp317, %cond_next268 ], [ 0, %bb318.preheader ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.1362 to i64		; <i64> [#uses=0]
...
bb318.preheader:		; preds = %bb122, %entry
	...
	call i32 (...)* @loop_enter( i32 54 )		; <i32>:2 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 15 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 55 )		; <i32>:1 [#uses=0]
	br i1 %tmp35326, label %bb, label %bb142

bb:		; preds = %bb, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp28, %bb ], [ 0, %entry ]		; <i32> [#uses=3]
	%zext = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb38:		; preds = %bb142, %cond_next
	%i.1.reg2mem.0 = phi i32 [ %tmp141, %cond_next ], [ 0, %bb142 ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.1.reg2mem.0 to i64		; <i64> [#uses=0]
...
cond_true:		; preds = %bb38
	...
	call i32 (...)* @loop_enter( i32 57 )		; <i32>:2 [#uses=0]
...
bb79:		; preds = %bb79, %cond_true
	...
	%i2.0353 = phi i32 [ %tmp113, %bb79 ], [ 0, %cond_true ]		; <i32> [#uses=4]
	%zext3 = zext i32 %i2.0353 to i64		; <i64> [#uses=0]
	%zext2 = zext i32 %i2.0353 to i64		; <i64> [#uses=0]
...
bb142:		; preds = %bb, %entry
	...
	call i32 (...)* @loop_enter( i32 56 )		; <i32>:3 [#uses=0]
	br i1 %tmp148, label %bb38, label %bb219

bb152:		; preds = %bb219, %cond_next216
	%i.2.reg2mem.0 = phi i32 [ %tmp218, %cond_next216 ], [ 0, %bb219 ]		; <i32> [#uses=3]
	%zext4 = zext i32 %i.2.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb219:		; preds = %bb142, %cond_next
	...
	call i32 (...)* @loop_enter( i32 58 )		; <i32>:4 [#uses=0]
	br i1 %tmp225, label %bb152, label %bb310.preheader

bb230:		; preds = %bb299.preheader, %cond_next296
	%x.0344 = phi i32 [ %tmp298, %cond_next296 ], [ 0, %bb299.preheader ]		; <i32> [#uses=4]
	%zext7 = zext i32 %x.0344 to i64		; <i64> [#uses=0]
	%zext6 = zext i32 %x.0344 to i64		; <i64> [#uses=0]
...
bb310.preheader:		; preds = %bb219, %cond_next216
	...
	call i32 (...)* @loop_enter( i32 59 )		; <i32>:5 [#uses=0]
	br i1 %tmp315351, label %bb318, label %bb299.preheader

bb299.preheader:		; preds = %bb310.preheader, %bb307
	%y.0348 = phi i32 [ %tmp309, %bb307 ], [ 0, %bb310.preheader ]		; <i32> [#uses=3]
	%zext5 = zext i32 %y.0348 to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 60 )		; <i32>:6 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 16 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 63 )		; <i32>:1 [#uses=0]
	br i1 %tmp30391, label %bb, label %bb56

bb:		; preds = %bb, %entry
	%i.0.reg2mem.0 = phi i32 [ %tmp23, %bb ], [ 0, %entry ]		; <i32> [#uses=4]
	%zext = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb33:		; preds = %bb56, %bb33
	%i.1.reg2mem.0 = phi i32 [ %tmp55, %bb33 ], [ 0, %bb56 ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.1.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb56:		; preds = %bb, %entry
	...
	call i32 (...)* @loop_enter( i32 61 )		; <i32>:2 [#uses=0]
...
bb.nph:		; preds = %bb358.preheader
	...
	call i32 (...)* @loop_enter( i32 66 )		; <i32>:3 [#uses=0]
	br label %bb67

bb67:		; preds = %bb355, %bb.nph
	%indvar420 = phi i32 [ 0, %bb.nph ], [ %x.0408, %bb355 ]		; <i32> [#uses=7]
	%zext7 = zext i32 %indvar420 to i64		; <i64> [#uses=0]
	%zext3 = zext i32 %indvar420 to i64		; <i64> [#uses=0]
...
bb97.preheader:		; preds = %bb67
	...
	call i32 (...)* @loop_enter( i32 67 )		; <i32>:4 [#uses=0]
	br i1 %tmp341407, label %bb355, label %bb97

bb97:		; preds = %bb347, %bb97.preheader
	%indvar423 = phi i32 [ %indvar.next424, %bb347 ], [ 0, %bb97.preheader ]		; <i32> [#uses=5]
	%zext11 = zext i32 %indvar423 to i64		; <i64> [#uses=0]
	%zext8 = zext i32 %indvar423 to i64		; <i64> [#uses=0]
	%zext4 = zext i32 %indvar423 to i64		; <i64> [#uses=0]
	%y1.0.reg2mem.0 = add i32 %indvar423, %indvar425		; <i32> [#uses=2]
	call i32 (...)* @loop_enter( i32 64 )		; <i32>:5 [#uses=0]
	br label %bb100

bb100:		; preds = %bb337, %bb97
	%indvar = phi i32 [ 0, %bb97 ], [ %indvar.next419, %bb337 ]		; <i32> [#uses=6]
	%zext14 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext12 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext9 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext5 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb161.preheader:		; preds = %bb100
	...
	call i32 (...)* @loop_enter( i32 62 )		; <i32>:6 [#uses=0]
	br label %bb161
...
bb161:		; preds = %cond_next158, %bb161.preheader
	%i.2 = phi i32 [ 0, %bb161.preheader ], [ %indvar.next, %cond_next158 ]		; <i32> [#uses=8]
	%zext16 = zext i32 %i.2 to i64		; <i64> [#uses=0]
	%zext15 = zext i32 %i.2 to i64		; <i64> [#uses=0]
	%zext13 = zext i32 %i.2 to i64		; <i64> [#uses=0]
	%zext10 = zext i32 %i.2 to i64		; <i64> [#uses=0]
	%zext6 = zext i32 %i.2 to i64		; <i64> [#uses=0]
...
bb370.preheader:		; preds = %bb56, %bb33
	...
	call i32 (...)* @loop_enter( i32 65 )		; <i32>:7 [#uses=0]
	br i1 %tmp376417, label %return, label %bb358.preheader

bb358.preheader:		; preds = %bb370.preheader, %bb367
	%indvar425 = phi i32 [ %y.0413, %bb367 ], [ 0, %bb370.preheader ]		; <i32> [#uses=6]
	%zext2 = zext i32 %indvar425 to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 17 )		; <i32>:0 [#uses=0]
...
bb127.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 68 )		; <i32>:1 [#uses=0]
	br label %bb127

bb127:		; preds = %cond_next176, %bb127.preheader
	%indvar = phi i32 [ 0, %bb127.preheader ], [ %indvar.next, %cond_next176 ]		; <i32> [#uses=3]
	%zext = zext i32 %indvar to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 18 )		; <i32>:0 [#uses=0]
...
bb166.preheader:		; preds = %bb175, %cond_true119
	...
	call i32 (...)* @loop_enter( i32 71 )		; <i32>:1 [#uses=0]
	br label %bb166

bb129:		; preds = %bb166, %cond_next152.i
	%indvar = phi i32 [ %indvar.next, %cond_next152.i ], [ 0, %bb166 ]		; <i32> [#uses=4]
	%zext3 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext = zext i32 %indvar to i64		; <i64> [#uses=0]
	%x.0.reg2mem.0 = add i32 %indvar, %x.0		; <i32> [#uses=6]
...
bb166:		; preds = %cond_next163, %bb166.preheader
	...
	%iter_count_phi1 = phi i64 [ %inc_iter_counter2, %cond_next163 ], [ 0, %bb166.preheader ]		; <i64> [#uses=1]
	%inc_iter_counter2 = add i64 %iter_count_phi1, 1		; <i64> [#uses=1]
	%tmp169 = icmp sgt i32 %x.0, %x2.0		; <i1> [#uses=1]
	call i32 (...)* @loop_enter( i32 70 )		; <i32>:2 [#uses=0]
...
cond_true188:		; preds = %bb181
	...
	call i32 (...)* @loop_enter( i32 69 )		; <i32>:3 [#uses=0]
...
cond_true209:		; preds = %cond_false213.critedge, %cond_true188
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_false213.critedge ], [ 0, %cond_true188 ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=1]
...
entry:
	call i32 (...)* @func_enter( i32 19 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 80 )		; <i32>:1 [#uses=0]
	br label %bb100.i
...
bb100.i:		; preds = %cond_next363.i, %entry
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_next363.i ], [ 0, %entry ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=1]
...
cond_next363.i:		; preds = %cond_true359.i, %cond_false353.i, %cond_true349.i, %cond_true342.i
	...
	call i32 (...)* @loop_enter( i32 88 )		; <i32>:2 [#uses=0]
...
bb407.i:		; preds = %bb414.i, %bb386.i, %cond_next363.i
	...
	%iter_count_phi1 = phi i64 [ %inc_iter_counter2, %bb414.i ], [ %inc_iter_counter2, %bb386.i ], [ 0, %cond_next363.i ]		; <i64> [#uses=1]
	%inc_iter_counter2 = add i64 %iter_count_phi1, 1		; <i64> [#uses=2]
...
bb421.i:		; preds = %bb435.loopexit.i, %bb421.i
	%i.1455.i = phi i32 [ %tmp434.i, %bb421.i ], [ 0, %bb435.loopexit.i ]		; <i32> [#uses=3]
	%zext = zext i32 %i.1455.i to i64		; <i64> [#uses=0]
...
bb435.loopexit.i:		; preds = %bb414.i
	...
	call i32 (...)* @loop_enter( i32 76 )		; <i32>:3 [#uses=0]
...
_ZN9regmngobj13defineregionsEv.exit:		; preds = %bb435.loopexit.i, %bb421.i
	...
	call i32 (...)* @loop_enter( i32 87 )		; <i32>:4 [#uses=0]
	br i1 %tmp39133.i, label %bb.i, label %bb103.preheader.i

bb.i:		; preds = %bb.i, %_ZN9regmngobj13defineregionsEv.exit
	%i.0.reg2mem.0.i = phi i32 [ %tmp32.i3, %bb.i ], [ 0, %_ZN9regmngobj13defineregionsEv.exit ]		; <i32> [#uses=3]
	%zext3 = zext i32 %i.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
bb42.i:		; preds = %bb103.preheader.i, %cond_next.i10
	%i.1134.i = phi i32 [ %tmp102.i, %cond_next.i10 ], [ 0, %bb103.preheader.i ]		; <i32> [#uses=3]
	%zext4 = zext i32 %i.1134.i to i64		; <i64> [#uses=0]
...
bb103.preheader.i:		; preds = %bb.i, %_ZN9regmngobj13defineregionsEv.exit
	...
	call i32 (...)* @loop_enter( i32 86 )		; <i32>:5 [#uses=0]
...
_ZN9regmngobj14enlargeregionsEv.exit:		; preds = %bb103.preheader.i, %cond_next.i10
	...
	call i32 (...)* @loop_enter( i32 73 )		; <i32>:6 [#uses=0]
	br i1 %tmp199437.i, label %bb202.i, label %bb183.preheader.i

bb6.i:		; preds = %bb183.preheader.i, %cond_next180.i
	%x.0429.i = phi i32 [ %tmp182.i33, %cond_next180.i ], [ 0, %bb183.preheader.i ]		; <i32> [#uses=5]
	%zext24 = zext i32 %x.0429.i to i64		; <i64> [#uses=0]
	%zext23 = zext i32 %x.0429.i to i64		; <i64> [#uses=0]
...
bb183.preheader.i:		; preds = %bb191.i, %_ZN9regmngobj14enlargeregionsEv.exit
	%y.0434.i = phi i32 [ %tmp193.i, %bb191.i ], [ 0, %_ZN9regmngobj14enlargeregionsEv.exit ]		; <i32> [#uses=4]
	%zext22 = zext i32 %y.0434.i to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 91 )		; <i32>:7 [#uses=0]
...
bb202.i:		; preds = %bb191.i, %_ZN9regmngobj14enlargeregionsEv.exit
	...
	call i32 (...)* @loop_enter( i32 72 )		; <i32>:8 [#uses=0]
...
bb217.i:		; preds = %bb397.preheader.i, %cond_next394.i
	%x214.0420.i = phi i32 [ %tmp396.i, %cond_next394.i ], [ 0, %bb397.preheader.i ]		; <i32> [#uses=5]
	%zext21 = zext i32 %x214.0420.i to i64		; <i64> [#uses=0]
	%zext20 = zext i32 %x214.0420.i to i64		; <i64> [#uses=0]
...
bb397.preheader.i:		; preds = %bb405.i, %bb202.i
	%y215.0424.i = phi i32 [ %tmp407.i, %bb405.i ], [ 0, %bb202.i ]		; <i32> [#uses=4]
	%zext19 = zext i32 %y215.0424.i to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 74 )		; <i32>:9 [#uses=0]
...
_ZN9regmngobj10addregionsEv.exit:		; preds = %bb405.i, %bb202.i
	...
	call i32 (...)* @loop_enter( i32 89 )		; <i32>:10 [#uses=0]
	br i1 %tmp311878, label %bb314, label %bb295.outer

bb295.outer:		; preds = %bb306, %_ZN9regmngobj10addregionsEv.exit
	%y121.0.reg2mem.0.ph = phi i32 [ %tmp305, %bb306 ], [ 0, %_ZN9regmngobj10addregionsEv.exit ]		; <i32> [#uses=4]
	%zext16 = zext i32 %y121.0.reg2mem.0.ph to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 90 )		; <i32>:11 [#uses=0]
	br i1 %tmp300916, label %bb306, label %bb122

bb122:		; preds = %cond_next292, %bb295.outer
	%x120.0913 = phi i32 [ %tmp294, %cond_next292 ], [ 0, %bb295.outer ]		; <i32> [#uses=5]
	%zext18 = zext i32 %x120.0913 to i64		; <i64> [#uses=0]
	%zext17 = zext i32 %x120.0913 to i64		; <i64> [#uses=0]
...
bb314:		; preds = %bb306, %_ZN9regmngobj10addregionsEv.exit
	...
	call i32 (...)* @loop_enter( i32 85 )		; <i32>:12 [#uses=0]
	br i1 %tmp402885, label %bb386.outer, label %bb405

bb386.outer:		; preds = %bb397, %bb314
	%y.0.reg2mem.0.ph = phi i32 [ %tmp396, %bb397 ], [ 0, %bb314 ]		; <i32> [#uses=3]
	%zext5 = zext i32 %y.0.reg2mem.0.ph to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 75 )		; <i32>:13 [#uses=0]
	br i1 %tmp391935, label %bb317, label %bb397

bb317:		; preds = %cond_next383, %bb386.outer
	%x.0932 = phi i32 [ %tmp385, %cond_next383 ], [ 0, %bb386.outer ]		; <i32> [#uses=4]
	%zext7 = zext i32 %x.0932 to i64		; <i64> [#uses=0]
	%zext6 = zext i32 %x.0932 to i64		; <i64> [#uses=0]
...
bb405:		; preds = %bb397, %bb314
	...
	call i32 (...)* @loop_enter( i32 77 )		; <i32>:14 [#uses=0]
	br i1 %tmp461891, label %bb415, label %bb485.preheader

bb415:		; preds = %bb455, %bb405
	%i412.0.reg2mem.0 = phi i32 [ %tmp454, %bb455 ], [ 0, %bb405 ]		; <i32> [#uses=3]
	%zext8 = zext i32 %i412.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb465:		; preds = %bb485.preheader, %bb465
	%i.0927 = phi i32 [ %tmp484, %bb465 ], [ 0, %bb485.preheader ]		; <i32> [#uses=3]
	%zext9 = zext i32 %i.0927 to i64		; <i64> [#uses=0]
...
bb485.preheader:		; preds = %bb455, %bb405
	...
	call i32 (...)* @loop_enter( i32 84 )		; <i32>:15 [#uses=0]
...
bb494:		; preds = %bb485.preheader, %bb465
	...
	call i32 (...)* @loop_enter( i32 78 )		; <i32>:16 [#uses=0]
	br i1 %tmp564898, label %bb514, label %bb567

bb514:		; preds = %bb558, %bb494
	%i513.0.reg2mem.0 = phi i32 [ %tmp557, %bb558 ], [ 0, %bb494 ]		; <i32> [#uses=3]
	%zext10 = zext i32 %i513.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb567:		; preds = %bb558, %bb494
	...
	call i32 (...)* @loop_enter( i32 81 )		; <i32>:17 [#uses=0]
	br i1 %tmp773906, label %bb776, label %bb757.outer

bb757.outer:		; preds = %bb768, %bb567
	%y575.0.reg2mem.0.ph = phi i32 [ %tmp767, %bb768 ], [ 0, %bb567 ]		; <i32> [#uses=4]
	%zext13 = zext i32 %y575.0.reg2mem.0.ph to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 83 )		; <i32>:18 [#uses=0]
	br i1 %tmp762920, label %bb768, label %bb577

bb577:		; preds = %cond_next754, %bb757.outer
	%x574.0917 = phi i32 [ %tmp756, %cond_next754 ], [ 0, %bb757.outer ]		; <i32> [#uses=5]
	%zext15 = zext i32 %x574.0917 to i64		; <i64> [#uses=0]
	%zext14 = zext i32 %x574.0917 to i64		; <i64> [#uses=0]
...
bb776:		; preds = %bb768, %bb567
	...
	call i32 (...)* @loop_enter( i32 79 )		; <i32>:19 [#uses=0]
	br i1 %tmp834912, label %bb787, label %bb861.preheader

bb787:		; preds = %bb828, %bb776
	%i784.0.reg2mem.0 = phi i32 [ %tmp827, %bb828 ], [ 0, %bb776 ]		; <i32> [#uses=3]
	%zext11 = zext i32 %i784.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb838:		; preds = %bb861.preheader, %bb838
	%i.1922 = phi i32 [ %tmp860, %bb838 ], [ 0, %bb861.preheader ]		; <i32> [#uses=3]
	%zext12 = zext i32 %i.1922 to i64		; <i64> [#uses=0]
...
bb861.preheader:		; preds = %bb828, %bb776
	...
	call i32 (...)* @loop_enter( i32 82 )		; <i32>:20 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 20 )		; <i32>:0 [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 92 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb, %entry
	%i.0.reg2mem.0 = phi i32 [ 0, %entry ], [ %indvar.next, %bb ]		; <i32> [#uses=3]
	%zext = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb29:		; preds = %bb
	...
	call i32 (...)* @loop_enter( i32 94 )		; <i32>:2 [#uses=0]
...
bb.i:		; preds = %bb.i, %bb29
	%i.0.reg2mem.0.i = phi i32 [ %indvar.next328.i, %bb.i ], [ 0, %bb29 ]		; <i32> [#uses=3]
	%zext1 = zext i32 %i.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
cond_next115.i:		; preds = %cond_true69.i, %cond_next.i
	...
	call i32 (...)* @loop_enter( i32 99 )		; <i32>:3 [#uses=0]
...
bb203.preheader.i:		; preds = %cond_false.i
	...
	call i32 (...)* @loop_enter( i32 101 )		; <i32>:4 [#uses=0]
	br label %bb203.i
...
bb203.i:		; preds = %_ZN7way2obj12releasepointEii.exit.i, %bb203.preheader.i
	...
	%indvar.i = phi i32 [ 0, %bb203.preheader.i ], [ %indvar.next.i, %_ZN7way2obj12releasepointEii.exit.i ]		; <i32> [#uses=4]
	%tmp206209.reg2mem.0.i = phi i64 [ %tmp174177.i, %bb203.preheader.i ], [ %tmp206209.i, %_ZN7way2obj12releasepointEii.exit.i ]		; <i64> [#uses=1]
	%zext9 = zext i32 %indvar.i to i64		; <i64> [#uses=0]
	%zext3 = zext i32 %indvar.i to i64		; <i64> [#uses=0]
...
bb343.preheader.i.i:		; preds = %bb352.i.i, %cond_true79.i.i
	...
	call i32 (...)* @loop_enter( i32 102 )		; <i32>:5 [#uses=0]
	br label %bb343.i.i

bb86.i.i:		; preds = %bb86.preheader.i.i, %cond_true142.i.i
	%indvar553.i.i = phi i32 [ %indvar.next554.i.i, %cond_true142.i.i ], [ 0, %bb86.preheader.i.i ]		; <i32> [#uses=6]
	...
	%zext14 = zext i32 %indvar553.i.i to i64		; <i64> [#uses=0]
	%zext12 = zext i32 %indvar553.i.i to i64		; <i64> [#uses=0]
	%zext10 = zext i32 %indvar553.i.i to i64		; <i64> [#uses=0]
	%zext6 = zext i32 %indvar553.i.i to i64		; <i64> [#uses=0]
...
bb343.i.i:		; preds = %cond_next340.i.i, %bb343.preheader.i.i
	...
	%iter_count_phi4 = phi i64 [ %inc_iter_counter5, %cond_next340.i.i ], [ 0, %bb343.preheader.i.i ]		; <i64> [#uses=1]
	%inc_iter_counter5 = add i64 %iter_count_phi4, 1		; <i64> [#uses=1]
...
bb86.preheader.i.i:		; preds = %bb343.i.i
	call i32 (...)* @loop_enter( i32 100 )		; <i32>:6 [#uses=0]
...
bb86.us.i.i.preheader:		; preds = %bb86.preheader.i.i
	...
	call i32 (...)* @loop_enter( i32 97 )		; <i32>:7 [#uses=0]
	br label %bb86.us.i.i

bb86.us.i.i:		; preds = %cond_true142.us.i.i, %bb86.us.i.i.preheader
	%indvar.i.i = phi i32 [ %indvar.next.i.i, %cond_true142.us.i.i ], [ 0, %bb86.us.i.i.preheader ]		; <i32> [#uses=6]
	...
	%zext15 = zext i32 %indvar.i.i to i64		; <i64> [#uses=0]
	%zext13 = zext i32 %indvar.i.i to i64		; <i64> [#uses=0]
	%zext11 = zext i32 %indvar.i.i to i64		; <i64> [#uses=0]
	%zext7 = zext i32 %indvar.i.i to i64		; <i64> [#uses=0]
...
cond_next282.i.outer:		; preds = %bb255.i, %cond_next115.i
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %bb255.i ], [ 0, %cond_next115.i ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=1]
	...
	call i32 (...)* @loop_enter( i32 98 )		; <i32>:8 [#uses=0]
...
cond_next282.i:		; preds = %cond_next282.i.outer, %cond_true184.i
	...
	%.tmp.0 = phi i32 [ %.promoted, %cond_next282.i.outer ], [ %tmp188.i, %cond_true184.i ]		; <i32> [#uses=5]
	%tmp163.rle.i = phi i32 [ %tmp270307.i, %cond_true184.i ], [ %tmp163.rle.i.ph, %cond_next282.i.outer ]		; <i32> [#uses=2]
	%zext8 = zext i32 %.tmp.0 to i64		; <i64> [#uses=0]
	%zext2 = zext i32 %.tmp.0 to i64		; <i64> [#uses=0]
...
cond_next88.i:		; preds = %cond_true.i3, %cond_next60
	...
	store i32 1, i32* %waylength, align 4
	call i32 (...)* @loop_enter( i32 93 )		; <i32>:9 [#uses=0]
...
bb.nph.i:		; preds = %bb364.preheader.i
	...
	call i32 (...)* @loop_enter( i32 95 )		; <i32>:10 [#uses=0]
	br label %bb217.i

bb217.i:		; preds = %cond_next361.i, %bb.nph.i
	%indvar658.i = phi i32 [ 0, %bb.nph.i ], [ %indvar.next659.i, %cond_next361.i ]		; <i32> [#uses=4]
	...
	%zext18 = zext i32 %indvar658.i to i64		; <i64> [#uses=0]
	%zext17 = zext i32 %indvar658.i to i64		; <i64> [#uses=0]
...
cond_next496.i:		; preds = %bb489.i, %cond_next88.i
	%index.0.reg2mem.0.i = phi i32 [ 0, %cond_next88.i ], [ %wayar.1.0.reg2mem.0.i, %bb489.i ]		; <i32> [#uses=4]
	...
	%zext16 = zext i32 %index.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
bb534.preheader.i:		; preds = %cond_next523.i
	...
	call i32 (...)* @loop_enter( i32 96 )		; <i32>:11 [#uses=0]
	br label %bb534.i

bb534.i:		; preds = %bb534.i, %bb534.preheader.i
	%indvar.i10 = phi i32 [ 0, %bb534.preheader.i ], [ %indvar.next.i12, %bb534.i ]		; <i32> [#uses=4]
	%zext19 = zext i32 %indvar.i10 to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 21 )		; <i32>:0 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 22 )		; <i32>:0 [#uses=0]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 103 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb, %bb.preheader
	%y.0.reg2mem.0 = phi i32 [ %tmp248, %bb ], [ 0, %bb.preheader ]		; <i32> [#uses=3]
	%zext = zext i32 %y.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb258:		; preds = %bb258.preheader, %bb258
	%y.1.reg2mem.0 = phi i32 [ %tmp274, %bb258 ], [ 0, %bb258.preheader ]		; <i32> [#uses=3]
	%zext1 = zext i32 %y.1.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb258.preheader:		; preds = %bb275
	...
	call i32 (...)* @loop_enter( i32 105 )		; <i32>:2 [#uses=0]
	br label %bb258

bb284:		; preds = %bb284.preheader, %bb284
	%x.0.reg2mem.0 = phi i32 [ %tmp292, %bb284 ], [ 0, %bb284.preheader ]		; <i32> [#uses=3]
	%zext2 = zext i32 %x.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb284.preheader:		; preds = %bb293
	...
	call i32 (...)* @loop_enter( i32 104 )		; <i32>:3 [#uses=0]
	br label %bb284

bb302:		; preds = %bb302.preheader, %bb302
	%x.1385 = phi i32 [ %tmp318, %bb302 ], [ 0, %bb302.preheader ]		; <i32> [#uses=3]
	%zext3 = zext i32 %x.1385 to i64		; <i64> [#uses=0]
...
bb302.preheader:		; preds = %bb319.preheader
	...
	call i32 (...)* @loop_enter( i32 106 )		; <i32>:4 [#uses=0]
	br label %bb302
...
entry:
	call i32 (...)* @func_enter( i32 23 )		; <i32>:0 [#uses=0]
...
bb133.preheader.i:		; preds = %cond_next.i
	...
	call i32 (...)* @loop_enter( i32 111 )		; <i32>:1 [#uses=0]
	br label %bb133.outer.i

bb133.outer.i:		; preds = %bb144.i, %bb133.preheader.i
	%indvar170.i = phi i32 [ 0, %bb133.preheader.i ], [ %y.0.reg2mem.0.ph.i, %bb144.i ]		; <i32> [#uses=3]
	%zext20 = zext i32 %indvar170.i to i64		; <i64> [#uses=0]
...
bb106.i.preheader:		; preds = %bb133.outer.i
	...
	call i32 (...)* @loop_enter( i32 112 )		; <i32>:2 [#uses=0]
	br label %bb106.i

bb106.i:		; preds = %bb106.i, %bb106.i.preheader
	%indvar.i = phi i32 [ %x.0166.i, %bb106.i ], [ 0, %bb106.i.preheader ]		; <i32> [#uses=4]
	%zext22 = zext i32 %indvar.i to i64		; <i64> [#uses=0]
	%zext21 = zext i32 %indvar.i to i64		; <i64> [#uses=0]
...
cond_next.i30:		; preds = %_ZN6wayobj7loadmapEPKc.exit
	...
	call i32 (...)* @loop_enter( i32 110 )		; <i32>:3 [#uses=0]
	br label %bb.i

bb.i:		; preds = %bb.i, %cond_next.i30
	%i.0.reg2mem.0.i = phi i32 [ 0, %cond_next.i30 ], [ %indvar.next.i, %bb.i ]		; <i32> [#uses=3]
	%zext19 = zext i32 %i.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
_ZN9regmngobj7loadmapEPKc.exit:		; preds = %bb164.i, %_ZN6wayobj7loadmapEPKc.exit
	...
	call i32 (...)* @loop_enter( i32 114 )		; <i32>:4 [#uses=0]
	br i1 %tmp180923, label %bb, label %bb183

bb:		; preds = %bb176, %_ZN9regmngobj7loadmapEPKc.exit
	%i.0.reg2mem.0 = phi i32 [ %tmp175, %bb176 ], [ 0, %_ZN9regmngobj7loadmapEPKc.exit ]		; <i32> [#uses=2]
...
bb183:		; preds = %bb176, %_ZN9regmngobj7loadmapEPKc.exit
	...
	call i32 (...)* @loop_enter( i32 120 )		; <i32>:5 [#uses=0]
	br i1 %tmp275928, label %bb186, label %bb278

bb186:		; preds = %bb271, %bb183
	%i.1.reg2mem.0 = phi i32 [ %tmp270, %bb271 ], [ 0, %bb183 ]		; <i32> [#uses=2]
...
cond_next.i580:		; preds = %bb278
	...
	call i32 (...)* @loop_enter( i32 109 )		; <i32>:6 [#uses=0]
	br label %bb.i586

bb.i586:		; preds = %bb.i586, %cond_next.i580
	%i.0.reg2mem.0.i581 = phi i32 [ 0, %cond_next.i580 ], [ %indvar.next.i584, %bb.i586 ]		; <i32> [#uses=3]
	%zext18 = zext i32 %i.0.reg2mem.0.i581 to i64		; <i64> [#uses=0]
...
bb299.preheader:		; preds = %_ZN7way2obj7loadmapEPKc.exit
	...
	call i32 (...)* @loop_enter( i32 119 )		; <i32>:7 [#uses=0]
	br label %bb299.outer

bb299.outer:		; preds = %bb438, %bb299.preheader
	%i.2.reg2mem.0.ph = phi i32 [ 0, %bb299.preheader ], [ %tmp437, %bb438 ]		; <i32> [#uses=2]
	...
	%zext2 = zext i32 %i.2.reg2mem.0.ph to i64		; <i64> [#uses=0]
	call i32 (...)* @loop_enter( i32 115 )		; <i32>:8 [#uses=0]
	br label %bb291

bb291:		; preds = %bb291, %bb299.outer
	%j.0965 = phi i32 [ 0, %bb299.outer ], [ %indvar.next984, %bb291 ]		; <i32> [#uses=5]
	%zext4 = zext i32 %j.0965 to i64		; <i64> [#uses=0]
	%zext3 = zext i32 %j.0965 to i64		; <i64> [#uses=0]
...
bb466.preheader:		; preds = %bb445
	...
	call i32 (...)* @loop_enter( i32 122 )		; <i32>:9 [#uses=0]
	br label %bb466.outer

bb466.outer:		; preds = %bb609, %bb466.preheader
	%i.3.reg2mem.0.ph = phi i32 [ 0, %bb466.preheader ], [ %tmp608, %bb609 ]		; <i32> [#uses=2]
	...
	%zext5 = zext i32 %i.3.reg2mem.0.ph to i64		; <i64> [#uses=0]
	call i32 (...)* @loop_enter( i32 123 )		; <i32>:10 [#uses=0]
	br label %bb458

bb458:		; preds = %bb458, %bb466.outer
	%j457.0963 = phi i32 [ 0, %bb466.outer ], [ %indvar.next979, %bb458 ]		; <i32> [#uses=5]
	%zext7 = zext i32 %j457.0963 to i64		; <i64> [#uses=0]
	%zext6 = zext i32 %j457.0963 to i64		; <i64> [#uses=0]
...
bb616:		; preds = %bb609, %bb445
	...
	call i32 (...)* @loop_enter( i32 116 )		; <i32>:11 [#uses=0]
	br label %bb.i349

bb.i349:		; preds = %bb.i349, %bb616
	%i.0.reg2mem.0.i343 = phi i32 [ 0, %bb616 ], [ %indvar.next.i347, %bb.i349 ]		; <i32> [#uses=3]
	%zext8 = zext i32 %i.0.reg2mem.0.i343 to i64		; <i64> [#uses=0]
...
_ZN7way2obj7destroyEv.exit:		; preds = %bb.i349
	...
	store i16 0, i16* getelementptr (%struct.regmngobj* @regmng, i32 0, i32 1), align 8
	call i32 (...)* @loop_enter( i32 108 )		; <i32>:12 [#uses=0]
	br label %bb.i285

bb.i285:		; preds = %bb.i285, %_ZN7way2obj7destroyEv.exit
	%i.0.reg2mem.0.i281 = phi i32 [ 0, %_ZN7way2obj7destroyEv.exit ], [ %indvar.next.i283, %bb.i285 ]		; <i32> [#uses=3]
	%zext9 = zext i32 %i.0.reg2mem.0.i281 to i64		; <i64> [#uses=0]
...
bb669.preheader:		; preds = %_ZN9regmngobj7initmapEii.exit
	...
	call i32 (...)* @loop_enter( i32 121 )		; <i32>:13 [#uses=0]
...
bb669.outer:		; preds = %bb675, %bb669.preheader
	...
	%y630.0.reg2mem.0.ph = phi i32 [ 0, %bb669.preheader ], [ %indvar.next975, %bb675 ]		; <i32> [#uses=4]
	%zext10 = zext i32 %y630.0.reg2mem.0.ph to i64		; <i64> [#uses=0]
	%tmp650 = mul i32 %y630.0.reg2mem.0.ph, %tmp628		; <i32> [#uses=1]
	%tmp7.i254 = shl i32 %y630.0.reg2mem.0.ph, %tmp5.i253		; <i32> [#uses=1]
	call i32 (...)* @loop_enter( i32 113 )		; <i32>:14 [#uses=0]
	br label %bb669
...
bb640:		; preds = %bb669, %cond_true647
	...
	%indvar = phi i32 [ %indvar.next973, %cond_true647 ], [ 0, %bb669 ]		; <i32> [#uses=5]
	%zext15 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext14 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext11 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb669:		; preds = %cond_true.i, %cond_false, %bb669.outer
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_true.i ], [ %inc_iter_counter, %cond_false ], [ 0, %bb669.outer ]		; <i64> [#uses=1]
	%iter_count_phi12 = phi i64 [ %inc_iter_counter13, %cond_true.i ], [ %inc_iter_counter13, %cond_false ], [ 0, %bb669.outer ]		; <i64> [#uses=1]
	%inc_iter_counter13 = add i64 %iter_count_phi12, 1		; <i64> [#uses=2]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=2]
	%tmp672 = icmp slt i32 %x629.0, %tmp628		; <i1> [#uses=1]
	call i32 (...)* @loop_enter( i32 107 )		; <i32>:15 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 24 )		; <i32>:0 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 25 )		; <i32>:0 [#uses=0]
...
cond_next81.i:		; preds = %cond_true.i, %_ZN9regmngobj13getregfillnumEv.exit.i
	...
	call i32 (...)* @loop_enter( i32 124 )		; <i32>:1 [#uses=0]
	br label %cond_next139.i
...
cond_next139.i:		; preds = %cond_next125.i, %cond_next81.i
	...
	%iter_count_phi = phi i64 [ %inc_iter_counter, %cond_next125.i ], [ 0, %cond_next81.i ]		; <i64> [#uses=1]
	%inc_iter_counter = add i64 %iter_count_phi, 1		; <i64> [#uses=1]
...
bb.preheader.i:		; preds = %cond_next26
	...
	call i32 (...)* @loop_enter( i32 126 )		; <i32>:2 [#uses=0]
	br label %bb.i
...
bb.i:		; preds = %cond_next188.i, %bb.preheader.i
	...
	%indvar.i = phi i32 [ 0, %bb.preheader.i ], [ %indvar.next239.i, %cond_next188.i ]		; <i32> [#uses=4]
	%tmp23.reg2mem.0.i = phi %struct.regobj** [ %tmp10.i, %bb.preheader.i ], [ %tmp23.i, %cond_next188.i ]		; <%struct.regobj**> [#uses=1]
	%zext = zext i32 %indvar.i to i64		; <i64> [#uses=0]
...
bb28.preheader.i:		; preds = %bb.i
	...
	call i32 (...)* @loop_enter( i32 125 )		; <i32>:3 [#uses=0]
	br label %bb28.i

bb28.i:		; preds = %bb172.i, %bb28.preheader.i
	%j.0.reg2mem.0.i = phi i32 [ 0, %bb28.preheader.i ], [ %tmp171.i, %bb172.i ]		; <i32> [#uses=4]
	...
	%zext2 = zext i32 %j.0.reg2mem.0.i to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %j.0.reg2mem.0.i to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 26 )		; <i32>:0 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 27 )		; <i32>:0 [#uses=0]
	%tmp8 = getelementptr %struct.boundart* %b2arp, i32 0, i32 1		; <i32*> [#uses=5]
	store i32 0, i32* %tmp8, align 8
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 127 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb176, %bb.preheader
	%j.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp175, %bb176 ]		; <i32> [#uses=3]
	%zext = zext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=0]
	%tmp15 = load %struct.pointt** %tmp14, align 8		; <%struct.pointt*> [#uses=2]
	%tmp1617 = sext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=2]
	%tmp22 = getelementptr %struct.pointt* %tmp15, i64 %tmp1617, i32 0		; <i32*> [#uses=1]
...
bb158.preheader:		; preds = %bb167, %cond_true110
	...
	call i32 (...)* @loop_enter( i32 128 )		; <i32>:2 [#uses=0]
	br i1 %tmp161202, label %bb164, label %bb120

bb120:		; preds = %cond_next155, %bb158.preheader
	%indvar = phi i32 [ %indvar.next, %cond_next155 ], [ 0, %bb158.preheader ]		; <i32> [#uses=4]
	%zext2 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 28 )		; <i32>:0 [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 29 )		; <i32>:0 [#uses=0]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 129 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb161, %bb.preheader
	%j.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp160, %bb161 ]		; <i32> [#uses=3]
	%zext = zext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
bb20.preheader:		; preds = %bb
	...
	call i32 (...)* @loop_enter( i32 130 )		; <i32>:2 [#uses=0]
	br label %bb20

bb20:		; preds = %bb149, %bb20.preheader
	%i.0.reg2mem.0 = phi i32 [ 0, %bb20.preheader ], [ %tmp148, %bb149 ]		; <i32> [#uses=4]
	%zext2 = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=0]
...
entry:
	call i32 (...)* @func_enter( i32 30 )		; <i32>:0 [#uses=0]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 131 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %cond_next530, %bb.preheader
	%i.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp545, %cond_next530 ]		; <i32> [#uses=3]
...
entry:
	call i32 (...)* @func_enter( i32 31 )		; <i32>:0 [#uses=0]
	%tmp3 = load i32* @way.8, align 8		; <i32> [#uses=4]
	%tmp6 = load %struct.point16t** @way.17, align 8		; <%struct.point16t*> [#uses=16]
...
bb.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 132 )		; <i32>:1 [#uses=0]
	br label %bb

bb:		; preds = %bb602, %bb.preheader
	%i.0.reg2mem.0 = phi i32 [ 0, %bb.preheader ], [ %tmp601, %bb602 ]		; <i32> [#uses=3]
