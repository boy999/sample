...
@.str6 = internal constant [23 x i8] c"Error in createregions\00"		; <[23 x i8]*> [#uses=1]
...
@way.5 = internal global i32 0		; <i32*> [#uses=3]
@way.6 = internal global i32 0		; <i32*> [#uses=3]
...
@.str17 = internal constant [33 x i8] c"Create regional map time : %.0f\0A\00"		; <[33 x i8]*> [#uses=1]
@.str12 = internal constant [25 x i8] c"Create ways time : %.0f\0A\00"		; <[25 x i8]*> [#uses=1]
@.str28 = internal constant [22 x i8] c"Ways quantity : %lld\0A\00"		; <[22 x i8]*> [#uses=1]
@.str39 = internal constant [25 x i8] c"Total way length : %lld\0A\00"		; <[25 x i8]*> [#uses=1]
@.str410 = internal constant [29 x i8] c"Create reg ways time : %.0f\0A\00"		; <[29 x i8]*> [#uses=1]
@.str511 = internal constant [26 x i8] c"Reg ways quantity : %lld\0A\00"		; <[26 x i8]*> [#uses=1]
@.str612 = internal constant [29 x i8] c"Total reg way length : %lld\0A\00"		; <[29 x i8]*> [#uses=1]
...
@.str1713 = internal constant [31 x i8] c"Cannot read configuration file\00"		; <[31 x i8]*> [#uses=1]
...
@cg_caller_id_var = internal global i32 1		; <i32*> [#uses=663]
@cg_caller_call_site_var = internal global i32 0		; <i32*> [#uses=533]
...
cond_next11.i:		; preds = %entry
	%tmp14.i = load i32* @way.5, align 8		; <i32> [#uses=2]
...
cond_next21.i:		; preds = %cond_next11.i
	%tmp25.i = load i32* @way.6, align 8		; <i32> [#uses=2]
...
cond_next:		; preds = %cond_next21.i
	...
	%tmp16.i14 = icmp slt i32 %tmp14.i, %endx		; <i1> [#uses=1]
	%bothcond = or i1 %bothcond.i12, %tmp16.i14		; <i1> [#uses=1]
	%phitmp = icmp slt i32 %tmp25.i, %endy		; <i1> [#uses=1]
	%bothcond3 = or i1 %bothcond, %phitmp		; <i1> [#uses=1]
	br i1 %bothcond3, label %cond_true21, label %bb16

bb16:		; preds = %cond_next
...
cond_true21:		; preds = %cond_next, %cond_next21.i, %cond_next11.i, %entry
...
cond_next.i:		; preds = %cond_true.i, %cond_next75
	...
	%tmp40.i = load i32* @way.2, align 8		; <i32> [#uses=8]
	%tmp42.i = shl i32 %starty, %tmp40.i		; <i32> [#uses=1]
	%tmp44.i = or i32 %tmp42.i, %startx		; <i32> [#uses=4]
...
cond_next139.i:		; preds = %bb133.i, %cond_next.i
	...
	%val3 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=6]
	%val4 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=6]
	store i32 31, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 31 )
...
cond_next90:		; preds = %_ZN6wayobj4fillEiiii.exit
	...
	%tmp154.i = load i32* @way.21, align 8		; <i32> [#uses=4]
	%tmp156.i = and i32 %tmp154.i, %tmp44.i		; <i32> [#uses=2]
	%tmp168.i = ashr i32 %tmp44.i, %tmp40.i		; <i32> [#uses=2]
...
bb174.i:		; preds = %bb562.i, %cond_next90
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 32 )
...
bb567.i:		; preds = %bb562.i, %cond_next90
	...
	%tmp597598599602.i = trunc i32 %tmp156.i to i16		; <i16> [#uses=1]
	%tmp582583584603.i = trunc i32 %tmp168.i to i16		; <i16> [#uses=1]
...
cond_next212:		; preds = %bb206, %cond_next113
	...
	store i32 33, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 33 )
...
bb:		; preds = %bb166, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 34 )
...
bb112:		; preds = %cond_next145, %bb148.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 35 )
...
bb182:		; preds = %cond_next216, %bb.nph
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 36 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 7 )
...
bb:		; preds = %bb328, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 37 )
	%tmp15 = load %struct.pointt** %tmp14, align 8		; <%struct.pointt*> [#uses=2]
	%tmp1617 = sext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=2]
	%tmp22 = getelementptr %struct.pointt* %tmp15, i64 %tmp1617, i32 0		; <i32*> [#uses=1]
	%tmp23 = load i32* %tmp22, align 4		; <i32> [#uses=2]
...
bb112:		; preds = %bb310, %cond_true182
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 39 )
...
bb310:		; preds = %cond_next307, %bb310.preheader
	...
	%val31 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=7]
	%val42 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=7]
	store i32 38, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 38 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 8 )
...
bb333:		; preds = %bb524, %cond_true403
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 42 )
	%x.0.reg2mem.0 = add i32 %indvar, %x.0		; <i32> [#uses=6]
...
bb524:		; preds = %cond_next521, %bb524.preheader
	...
	%val42 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=7]
	store i32 41, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 41 )
...
cond_next563:		; preds = %cond_false, %cond_true548, %bb539
	...
	store i32 40, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 40 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 9 )
...
bb94.i:		; preds = %cond_next.i, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 43 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 10 )
...
bb:		; preds = %bb, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 44 )
...
bb53:		; preds = %bb101.outer, %cond_next
	...
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 47 )
...
bb101.outer:		; preds = %bb112, %bb109
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 46 )
...
bb121:		; preds = %cond_next189, %bb192.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 45 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 11 )
...
bb:		; preds = %bb, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 48 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 12 )
...
bb24:		; preds = %bb166, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 49 )
...
bb199:		; preds = %bb206, %bb199.preheader, %bb177
	...
	%val31 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=4]
	%val42 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=4]
	store i32 50, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 50 )
...
bb213:		; preds = %bb227.loopexit, %bb213
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 51 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 13 )
...
bb23:		; preds = %bb122, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 52 )
	%tmp31 = load %struct.regobj*** getelementptr (%struct.regmngobj* @regmng, i32 0, i32 18, i32 0), align 8		; <%struct.regobj**> [#uses=1]
...
bb132:		; preds = %bb318.preheader, %cond_next268
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 53 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 14 )
...
bb:		; preds = %bb, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 54 )
...
bb38:		; preds = %bb142, %cond_next
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 55 )
...
bb79:		; preds = %bb79, %cond_true
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 56 )
...
bb152:		; preds = %bb219, %cond_next216
	...
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 57 )
...
bb230:		; preds = %bb299.preheader, %cond_next296
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 59 )
...
bb299.preheader:		; preds = %bb310.preheader, %bb307
	...
	call fastcc void @CallEdgeProfiler( i32 %val37, i32 %val48, i32 58 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 15 )
...
bb:		; preds = %bb, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 60 )
...
bb33:		; preds = %bb56, %bb33
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 61 )
...
bb67:		; preds = %bb355, %bb.nph
	...
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 63 )
...
bb97:		; preds = %bb347, %bb97.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val37, i32 %val48, i32 64 )
...
bb100:		; preds = %bb337, %bb97
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 65 )
...
bb161:		; preds = %cond_next158, %bb161.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val311, i32 %val412, i32 66 )
...
bb358.preheader:		; preds = %bb370.preheader, %bb367
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 62 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 16 )
...
bb127:		; preds = %cond_next176, %bb127.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 67 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 17 )
...
bb129:		; preds = %bb166, %cond_next152.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 70 )
	%x.0.reg2mem.0 = add i32 %indvar, %x.0		; <i32> [#uses=6]
...
bb166:		; preds = %cond_next163, %bb166.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 69 )
...
bb181:		; preds = %bb175, %cond_true119
	%tmp183 = load i32* getelementptr (%struct.boundart* @_ZN6regobj9bound1arpE, i32 0, i32 1), align 16		; <i32> [#uses=1]
...
cond_true209:		; preds = %cond_false213.critedge, %cond_true188
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 68 )
	store i32 0, i32* @cg_caller_call_site_var, align 4
	store i32 68, i32* @cg_caller_id_var, align 4
	...
	%storemerge263 = load i32* getelementptr (%struct.boundart* @_ZN6regobj9bound2arpE, i32 0, i32 1), align 4		; <i32> [#uses=1]
...
cond_false213.critedge:		; preds = %cond_true209
	...
	%storemerge = load i32* getelementptr (%struct.boundart* @_ZN6regobj9bound1arpE, i32 0, i32 1), align 4		; <i32> [#uses=1]
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 18 )
...
bb100.i:		; preds = %cond_next363.i, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 71 )
...
bb407.i:		; preds = %bb414.i, %bb386.i, %cond_next363.i
	...
	%val31 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=8]
	%val42 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=8]
	store i32 72, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 72 )
...
bb421.i:		; preds = %bb435.loopexit.i, %bb421.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 73 )
...
bb.i:		; preds = %bb.i, %_ZN9regmngobj13defineregionsEv.exit
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 74 )
...
bb42.i:		; preds = %bb103.preheader.i, %cond_next.i10
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 75 )
...
bb6.i:		; preds = %bb183.preheader.i, %cond_next180.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val337, i32 %val438, i32 90 )
...
bb183.preheader.i:		; preds = %bb191.i, %_ZN9regmngobj14enlargeregionsEv.exit
	...
	call fastcc void @CallEdgeProfiler( i32 %val335, i32 %val436, i32 89 )
...
bb217.i:		; preds = %bb397.preheader.i, %cond_next394.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val333, i32 %val434, i32 88 )
...
bb397.preheader.i:		; preds = %bb405.i, %bb202.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val331, i32 %val432, i32 87 )
...
bb295.outer:		; preds = %bb306, %_ZN9regmngobj10addregionsEv.exit
	...
	call fastcc void @CallEdgeProfiler( i32 %val327, i32 %val428, i32 85 )
...
bb122:		; preds = %cond_next292, %bb295.outer
	...
	call fastcc void @CallEdgeProfiler( i32 %val329, i32 %val430, i32 86 )
...
bb386.outer:		; preds = %bb397, %bb314
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 76 )
...
bb317:		; preds = %cond_next383, %bb386.outer
	...
	call fastcc void @CallEdgeProfiler( i32 %val311, i32 %val412, i32 77 )
...
cond_true379:		; preds = %cond_true345
	store i32 0, i32* @cg_caller_call_site_var, align 4
	store i32 77, i32* @cg_caller_id_var, align 4
	%tmp381 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([23 x i8]* @.str6, i32 0, i64 0) )		; <i32> [#uses=0]
...
bb415:		; preds = %bb455, %bb405
	...
	call fastcc void @CallEdgeProfiler( i32 %val313, i32 %val414, i32 78 )
...
bb465:		; preds = %bb485.preheader, %bb465
	...
	call fastcc void @CallEdgeProfiler( i32 %val315, i32 %val416, i32 79 )
...
bb514:		; preds = %bb558, %bb494
	...
	call fastcc void @CallEdgeProfiler( i32 %val317, i32 %val418, i32 80 )
...
bb757.outer:		; preds = %bb768, %bb567
	...
	call fastcc void @CallEdgeProfiler( i32 %val323, i32 %val424, i32 83 )
...
bb577:		; preds = %cond_next754, %bb757.outer
	...
	call fastcc void @CallEdgeProfiler( i32 %val325, i32 %val426, i32 84 )
...
bb787:		; preds = %bb828, %bb776
	...
	call fastcc void @CallEdgeProfiler( i32 %val319, i32 %val420, i32 81 )
...
bb838:		; preds = %bb861.preheader, %bb838
	...
	call fastcc void @CallEdgeProfiler( i32 %val321, i32 %val422, i32 82 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 19 )
...
bb:		; preds = %bb, %entry
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 91 )
...
bb.i:		; preds = %bb.i, %bb29
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 92 )
...
bb203.i:		; preds = %_ZN7way2obj12releasepointEii.exit.i, %bb203.preheader.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 95 )
...
bb86.i.i:		; preds = %bb86.preheader.i.i, %cond_true142.i.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 97 )
...
bb343.i.i:		; preds = %cond_next340.i.i, %bb343.preheader.i.i
	...
	%val39 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=11]
	%val410 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=11]
	store i32 96, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 96 )
...
bb86.us.i.i:		; preds = %cond_true142.us.i.i, %bb86.us.i.i.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 98 )
...
cond_next282.i.outer:		; preds = %bb255.i, %cond_next115.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 93 )
...
cond_next282.i:		; preds = %cond_next282.i.outer, %cond_true184.i
	...
	%val35 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=6]
	%val46 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=6]
	store i32 94, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 94 )
...
bb364.preheader.i:		; preds = %bb373.i, %cond_true209.i
	%val418.rle8 = phi i32 [ %val418.rle9, %bb373.i ], [ %val416, %cond_true209.i ]		; <i32> [#uses=3]
	%val317.rle5 = phi i32 [ %val317.rle6, %bb373.i ], [ %val315, %cond_true209.i ]		; <i32> [#uses=3]
...
bb217.i:		; preds = %cond_next361.i, %bb.nph.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val317.rle5, i32 %val418.rle8, i32 100 )
...
cond_next361.i:		; preds = %cond_true355.i, %cond_true295.i, %cond_false.i8, %cond_true238.i, %bb217.i
	...
	store i32 %val418.rle8, i32* @cg_caller_call_site_var, align 4
	store i32 %val317.rle5, i32* @cg_caller_id_var, align 4
...
bb373.i:		; preds = %bb370.i, %bb113.i
	%val418.rle9 = phi i32 [ %val418.rle8, %bb370.i ], [ %val416, %bb113.i ]		; <i32> [#uses=1]
	%val317.rle6 = phi i32 [ %val317.rle5, %bb370.i ], [ %val315, %bb113.i ]		; <i32> [#uses=1]
...
cond_next496.i:		; preds = %bb489.i, %cond_next88.i
	...
	%val315 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=7]
	%val416 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=7]
	store i32 99, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val315, i32 %val416, i32 99 )
...
bb534.i:		; preds = %bb534.i, %bb534.preheader.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val315, i32 %val416, i32 101 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 20 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 21 )
...
bb:		; preds = %bb, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 102 )
...
bb258:		; preds = %bb258.preheader, %bb258
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 103 )
...
bb284:		; preds = %bb284.preheader, %bb284
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 104 )
...
bb302:		; preds = %bb302.preheader, %bb302
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 105 )
...
cond_true37:		; preds = %cond_next
	store i32 4, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp39 = call i32 @puts( i8* getelementptr ([31 x i8]* @.str1713, i32 0, i64 0) ) nounwind 		; <i32> [#uses=0]
	call fastcc void @CallProfPrinter( )
	ret i32 1
...
bb133.outer.i:		; preds = %bb144.i, %bb133.preheader.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val329, i32 %val430, i32 121 )
...
bb106.i:		; preds = %bb106.i, %bb106.i.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val331, i32 %val432, i32 122 )
...
bb.i:		; preds = %bb.i, %cond_next.i30
	...
	call fastcc void @CallEdgeProfiler( i32 %val327, i32 %val428, i32 120 )
...
bb:		; preds = %bb176, %_ZN9regmngobj7loadmapEPKc.exit
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 106 )
	store i32 0, i32* %waylength, align 4
	store %struct.point16t* null, %struct.point16t** %wayar, align 8
...
bb186:		; preds = %bb271, %bb183
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 107 )
...
bb.i586:		; preds = %bb.i586, %cond_next.i580
	...
	call fastcc void @CallEdgeProfiler( i32 %val325, i32 %val426, i32 119 )
...
bb299.outer:		; preds = %bb438, %bb299.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 108 )
	br label %bb291
...
bb291:		; preds = %bb291, %bb299.outer
	...
	call fastcc void @CallEdgeProfiler( i32 %val35, i32 %val46, i32 109 )
...
bb466.outer:		; preds = %bb609, %bb466.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val37, i32 %val48, i32 110 )
	br label %bb458
...
bb458:		; preds = %bb458, %bb466.outer
	...
	call fastcc void @CallEdgeProfiler( i32 %val39, i32 %val410, i32 111 )
...
bb.i349:		; preds = %bb.i349, %bb616
	...
	call fastcc void @CallEdgeProfiler( i32 %val311, i32 %val412, i32 112 )
...
_ZN7way2obj7destroyEv.exit:		; preds = %bb.i349
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp4.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([33 x i8]* @.str17, i32 0, i64 0), double 0.000000e+00 )		; <i32> [#uses=0]
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp15.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([22 x i8]* @.str28, i32 0, i64 0), i64 %stat.8.5 )		; <i32> [#uses=0]
	store i32 75, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp20.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([25 x i8]* @.str39, i32 0, i64 0), i64 %stat.5.5 )		; <i32> [#uses=0]
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp26.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([29 x i8]* @.str410, i32 0, i64 0), double 0.000000e+00 )		; <i32> [#uses=0]
	store i32 78, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp31.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([26 x i8]* @.str511, i32 0, i64 0), i64 %stat.12.5 )		; <i32> [#uses=0]
	store i32 79, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp36.i = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([29 x i8]* @.str612, i32 0, i64 0), i64 %stat.11.5 )		; <i32> [#uses=0]
...
bb.i285:		; preds = %bb.i285, %_ZN7way2obj7destroyEv.exit
	...
	call fastcc void @CallEdgeProfiler( i32 %val313, i32 %val414, i32 113 )
...
bb669.outer:		; preds = %bb675, %bb669.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val313, i32 %val414, i32 114 )
...
bb640:		; preds = %bb669, %cond_true647
	...
	call fastcc void @CallEdgeProfiler( i32 %val317, i32 %val418, i32 116 )
...
bb669:		; preds = %cond_true.i, %cond_false, %bb669.outer
	...
	%val317 = load i32* @cg_caller_id_var, align 4		; <i32> [#uses=5]
	%val418 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=5]
	store i32 115, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val317, i32 %val418, i32 115 )
...
bb702:		; preds = %bb765, %bb684
	...
	call fastcc void @CallEdgeProfiler( i32 %val321, i32 %val422, i32 117 )
...
bb774:		; preds = %bb864, %bb772
	...
	call fastcc void @CallEdgeProfiler( i32 %val323, i32 %val424, i32 118 )
...
bb871:		; preds = %bb864, %bb772
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp4.i879 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([33 x i8]* @.str17, i32 0, i64 0), double 0.000000e+00 )		; <i32> [#uses=0]
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp15.i886 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([22 x i8]* @.str28, i32 0, i64 0), i64 %stat.8.2 )		; <i32> [#uses=0]
	store i32 107, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp20.i889 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([25 x i8]* @.str39, i32 0, i64 0), i64 %stat.5.2 )		; <i32> [#uses=0]
	...
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp26.i893 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([29 x i8]* @.str410, i32 0, i64 0), double 0.000000e+00 )		; <i32> [#uses=0]
	store i32 110, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp31.i896 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([26 x i8]* @.str511, i32 0, i64 0), i64 %stat.12.2 )		; <i32> [#uses=0]
	store i32 111, i32* @cg_caller_call_site_var, align 4
	store i32 22, i32* @cg_caller_id_var, align 4
	%tmp36.i899 = call i32 (i8*, ...)* @printf( i8* noalias  getelementptr ([29 x i8]* @.str612, i32 0, i64 0), i64 %stat.11.2 )		; <i32> [#uses=0]
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 23 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 24 )
...
cond_next139.i:		; preds = %cond_next125.i, %cond_next81.i
	...
	%val4 = load i32* @cg_caller_call_site_var, align 4		; <i32> [#uses=6]
	store i32 123, i32* @cg_caller_id_var, align 4
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 123 )
...
bb.i:		; preds = %cond_next188.i, %bb.preheader.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 124 )
...
bb28.i:		; preds = %bb172.i, %bb28.preheader.i
	...
	call fastcc void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 125 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 25 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 26 )
	%tmp8 = getelementptr %struct.boundart* %b2arp, i32 0, i32 1		; <i32*> [#uses=5]
	store i32 0, i32* %tmp8, align 8
...
bb:		; preds = %bb176, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 126 )
	%tmp15 = load %struct.pointt** %tmp14, align 8		; <%struct.pointt*> [#uses=2]
	%tmp1617 = sext i32 %j.0.reg2mem.0 to i64		; <i64> [#uses=2]
	%tmp22 = getelementptr %struct.pointt* %tmp15, i64 %tmp1617, i32 0		; <i32*> [#uses=1]
	%tmp23 = load i32* %tmp22, align 4		; <i32> [#uses=2]
...
bb120:		; preds = %cond_next155, %bb158.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 127 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 27 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 28 )
...
bb:		; preds = %bb161, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 128 )
...
bb20:		; preds = %bb149, %bb20.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 129 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 29 )
...
bb:		; preds = %cond_next530, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 130 )
...
entry:
	...
	call fastcc void @CallEdgeProfiler( i32 %val, i32 %val2, i32 30 )
	%tmp3 = load i32* @way.8, align 8		; <i32> [#uses=4]
	%tmp6 = load %struct.point16t** @way.17, align 8		; <%struct.point16t*> [#uses=16]
...
bb:		; preds = %bb602, %bb.preheader
	...
	call fastcc void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 131 )
	%tmp89 = sext i32 %i.0.reg2mem.0 to i64		; <i64> [#uses=1]
	%tmp10 = getelementptr i32* %bound1p, i64 %tmp89		; <i32*> [#uses=1]
	%tmp11 = load i32* %tmp10, align 4		; <i32> [#uses=6]
	%tmp14 = sub i32 %tmp11, %tmp3		; <i32> [#uses=5]
