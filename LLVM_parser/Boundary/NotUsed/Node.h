...
class Node
{
  protected:
    ...
    uint64_t mOutputToleranceThreshold;
...
//    BoostNode mBoostNode; 
  public:
    ...
    bool isPhiNode() { return mIsDummyPhiNode || llvm::isa<llvm::PHINode>(mLLVMValue); }
    ...
    //cloned node
    void setASIPClone(Node* X) { mASIPClonedNode = X; X->setASIPOriginal(this); }
    ...
    void setOutputToleranceThreshold(uint64_t val) 
    { mOutputToleranceThreshold = val;}
    uint64_t getOutputToleranceThreshold() { return mOutputToleranceThreshold; }
