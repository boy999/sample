...
@cg_caller_id_var = weak global i32 1		; <i32*> [#uses=75]
@cg_caller_call_site_var = weak global i32 0		; <i32*> [#uses=62]
...
bb390.outer:		; preds = %bb397, %entry
	...
	call void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 5 )
...
bb2:		; preds = %bb381.preheader, %bb2
	...
	call void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 7 )
...
bb381.preheader:		; preds = %bb387, %bb390.outer
	...
	store i32 6, i32* @cg_caller_id_var
	call void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 6 )
...
bb10:		; preds = %bb395.preheader, %bb10
	...
	call void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 10 )
...
bb395.preheader:		; preds = %bb401, %bb404.outer
	...
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 9, i32* @cg_caller_id_var
	call void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 9 )
...
bb27:		; preds = %bb51.preheader, %bb27
	...
	call void @CallEdgeProfiler( i32 %val33, i32 %val44, i32 13 )
	store i32 4, i32* @cg_caller_call_site_var
	store i32 4, i32* @cg_caller_id_var
	store i32 0, i32* @cg_caller_call_site_var
...
bb51.preheader:		; preds = %bb60.preheader, %bb57
	...
	%val42 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 12, i32* @cg_caller_id_var
	call void @CallEdgeProfiler( i32 %val31, i32 %val42, i32 12 )
	br label %bb27
...
bb60.preheader:		; preds = %bb66, %bb70.preheader
	...
	%val4 = load i32* @cg_caller_call_site_var		; <i32> [#uses=2]
	store i32 11, i32* @cg_caller_id_var
	call void @CallEdgeProfiler( i32 %val3, i32 %val4, i32 11 )
