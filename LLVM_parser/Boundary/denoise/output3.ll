...
@.str6 = internal constant [17 x i8] c"Now at denoise \0D\00"		; <[17 x i8]*> [#uses=1]
@.str17 = internal constant [11 x i8] c"data/T.img\00"		; <[11 x i8]*> [#uses=1]
@.str28 = internal constant [3 x i8] c"rb\00"		; <[3 x i8]*> [#uses=1]
@.str39 = internal constant [14 x i8] c"reading error\00"		; <[14 x i8]*> [#uses=1]
...
entry:
	%tmp1 = tail call i32 @puts( i8* getelementptr ([17 x i8]* @.str6, i32 0, i64 0) )		; <i32> [#uses=0]
...
entry:
	...
	%tmp20 = call %struct.FILE* @fopen( i8* noalias  getelementptr ([11 x i8]* @.str17, i32 0, i64 0), i8* noalias  getelementptr ([3 x i8]* @.str28, i32 0, i64 0) )		; <%struct.FILE*> [#uses=3]
...
cond_true:		; preds = %entry
	%tmp25 = call i32 @puts( i8* getelementptr ([14 x i8]* @.str39, i32 0, i64 0) )		; <i32> [#uses=0]
	ret i32 1
