...
entry:
	...
	call i32 (...)* @loop_enter( i32 6 )		; <i32>:1 [#uses=0]
	br label %bb390.outer

bb390.outer:		; preds = %bb397, %entry
	%indvar448 = phi i32 [ 0, %entry ], [ %p.0.reg2mem.0.ph, %bb397 ]		; <i32> [#uses=2]
	%zext = zext i32 %indvar448 to i64		; <i64> [#uses=0]
	%p.0.reg2mem.0.ph = add i32 %indvar448, 1		; <i32> [#uses=4]
	%tmp5 = shl i32 %p.0.reg2mem.0.ph, 4		; <i32> [#uses=1]
	call i32 (...)* @loop_enter( i32 7 )		; <i32>:2 [#uses=0]
	br label %bb381.preheader

bb2:		; preds = %bb381.preheader, %bb2
	%indvar = phi i32 [ 0, %bb381.preheader ], [ %m.0437, %bb2 ]		; <i32> [#uses=4]
	%zext5 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext4 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb381.preheader:		; preds = %bb387, %bb390.outer
	%indvar445 = phi i32 [ 0, %bb390.outer ], [ %n.0439, %bb387 ]		; <i32> [#uses=3]
	%zext3 = zext i32 %indvar445 to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %indvar445 to i64		; <i64> [#uses=0]
	...
	call i32 (...)* @loop_enter( i32 8 )		; <i32>:3 [#uses=0]
	br label %bb2
...
bb404.outer:		; preds = %bb411, %entry
	%indvar461 = phi i32 [ 0, %entry ], [ %p.0.reg2mem.0.ph, %bb411 ]		; <i32> [#uses=2]
	%zext = zext i32 %indvar461 to i64		; <i64> [#uses=0]
	%p.0.reg2mem.0.ph = add i32 %indvar461, 1		; <i32> [#uses=4]
	%tmp13 = shl i32 %p.0.reg2mem.0.ph, 4		; <i32> [#uses=1]
	call i32 (...)* @loop_enter( i32 9 )		; <i32>:2 [#uses=0]
	br label %bb395.preheader

bb10:		; preds = %bb395.preheader, %bb10
	%indvar = phi i32 [ 0, %bb395.preheader ], [ %m.0449, %bb10 ]		; <i32> [#uses=4]
	%zext5 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext4 = zext i32 %indvar to i64		; <i64> [#uses=0]
	%zext2 = zext i32 %indvar to i64		; <i64> [#uses=0]
...
bb395.preheader:		; preds = %bb401, %bb404.outer
	%indvar458 = phi i32 [ 0, %bb404.outer ], [ %n.0451, %bb401 ]		; <i32> [#uses=3]
	%zext3 = zext i32 %indvar458 to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %indvar458 to i64		; <i64> [#uses=0]
...
bb70.preheader:		; preds = %entry
	...
	call i32 (...)* @loop_enter( i32 14 )		; <i32>:1 [#uses=0]
...
bb27:		; preds = %bb51.preheader, %bb27
	%i.093 = phi i32 [ 0, %bb51.preheader ], [ %indvar.next, %bb27 ]		; <i32> [#uses=5]
	%zext5 = zext i32 %i.093 to i64		; <i64> [#uses=0]
	%zext4 = zext i32 %i.093 to i64		; <i64> [#uses=0]
	%zext2 = zext i32 %i.093 to i64		; <i64> [#uses=0]
...
bb51.preheader:		; preds = %bb60.preheader, %bb57
	%j.095 = phi i32 [ 0, %bb60.preheader ], [ %indvar.next103, %bb57 ]		; <i32> [#uses=4]
	%zext3 = zext i32 %j.095 to i64		; <i64> [#uses=0]
	%zext1 = zext i32 %j.095 to i64		; <i64> [#uses=0]
	call i32 (...)* @loop_enter( i32 13 )		; <i32>:2 [#uses=0]
	br label %bb27
...
bb60.preheader:		; preds = %bb66, %bb70.preheader
	%k.098 = phi i32 [ 0, %bb70.preheader ], [ %indvar.next105, %bb66 ]		; <i32> [#uses=3]
	%zext = zext i32 %k.098 to i64		; <i64> [#uses=0]
	call i32 (...)* @loop_enter( i32 12 )		; <i32>:3 [#uses=0]
