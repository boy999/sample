...
public:
  ...
  /*
     inline bool isSurfaceOnly()
     {
     if (m_firstInjectedTime < deadlockTime)
     return true;
     else
     return m_surfaceonly;
     }

	inline void setSurfaceOnly(bool val)
	  {
	    m_surfaceonly=val;
	  }
    */

  inline Time getFirstInjectedTime()
  {
    return m_firstInjectedTime;
  }
  inline xyyx_t xyyx()
  {
    return xy_or_yx;
