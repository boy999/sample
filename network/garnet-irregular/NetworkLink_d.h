...
public:
	...
	NetworkLink_d(int id, int link_latency, unsigned int flitCapacity, int direction, GarnetNetwork_d *net_ptr);
	void setLinkConsumer(Consumer *consumer);
	void setSourceQueue(flitBuffer_d *srcQueue, int routerId = -1);
...
protected:
			  // the direction this link is moving data
			  // -2 if n/a (or no direction)
	int m_direction;  // -1 if into-network, otherwise equal to
