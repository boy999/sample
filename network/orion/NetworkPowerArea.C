...
double NetworkLink_d::calculate_offline_power()
{
    ...
    P_link += E_link * PARM_Freq;
//    cerr << "Network Link power stats: " << endl;
//    cerr << "\t m_link_utilized = " << m_link_utilized << endl;
//    cerr << "\t m_flit_width = " << m_flit_width << endl;
//    cerr << "\t sim_cycles = " << sim_cycles << endl;
//    cerr << "\t e_link = " << e_link << endl;
//    cerr << "\t E_link = " << E_link << endl;
//    cerr << "\t P_link = " << P_link << endl;
//    cerr << "\t PARM_Freq = " << PARM_Freq << endl;
...
double NetworkLink_d::calculate_power()
{
    ...
    total_power = calculate_offline_power();
    return total_power;
}
...
double NetworkLink_CN::calculate_offline_power()
{
...
double NetworkLink_CN::calculate_power()
{
    double total_power;
...
double NetworkLink_CN::calculate_area()
{
    double larea = 0;
    larea = LinkArea(PARM_GENERIC_LINK_LENGTH, m_flit_width * 8);
    return larea;
