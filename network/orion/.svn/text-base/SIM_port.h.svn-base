...
/* general parameters */
#define PARM_in_port 		7	/* # of router input ports */
...
//#define PARM_v_class        5   /* # of total message classes */
...
#define PARM_crsbar_degree	6					/* crossbar mux degree */
