...
public:
    ...
    flit_d(int id, int vc, int vnet, int size, MsgPtr msg_ptr, int srcNetIntfId, int destNode, int CSNOC_index, bool setuporfree);	
	...
	{
        //flit_stage tmp_stage;
        //Time tmp_time;
        //tmp_stage = m_stage.first;
        //tmp_time = m_stage.second;
