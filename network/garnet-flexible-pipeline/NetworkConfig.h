...
class NetworkConfig {
	public:
		...
		static bool isCustomNetwork() {return g_CUSTOM_NETWORK; }
		static bool isButflyNetwork() {return g_BUTFLY_NETWORK; }
		static bool isClosNetwork() {return g_CLOS_NETWORK; }
		static bool isEVCNetwork() {return g_EVC_NETWORK; }
        static bool isIdealNetwork() {return g_IDEAL_NETWORK; }
        ...
        static int getIdealLatency() {return g_IDEAL_LATENCY; }
        static int getIdealPorts() {return g_IDEAL_PORT; }
        static int getCSPercent() {return g_CS_PERCENT; }
#ifdef STARFISH
		static int getBusLatency() { return g_BUS_LATENCY; } //Mishali
		static int getClusterSize() {return g_CLUSTER_SIZE; } //Mishali
		static int getTxClusterSize() {return g_TX_CLUSTER_SIZE; } //Mishali
		static int getRxClusterSize() {return g_RX_CLUSTER_SIZE; } //Mishali
		static int getSnoopScheme() { return g_SNOOP_SCHEME;} //Mishali
		static bool coalesceWrites() { return g_COALESCE_WRITES;}//Mishali
		static int numCoalesce() { return g_NUM_COALESCE;}//Mishali
#endif
