...
#ifndef INPUT_UNIT_CN_H
#define INPUT_UNIT_CN_H
...
class InputUnit_CN : public Consumer {
public:
	InputUnit_CN(int id, Router_CN *router);
	~InputUnit_CN();

//	void wakeup();
	void wakeup() {};
	void printConfig(ostream& out);
//	flitBuffer_CN* getCreditQueue() { return creditQueue; }
...
//	{
//		flit_CN *t_flit = new flit_CN(in_vc, free_signal);
...
//	inline flit_CN* peekTopFlit(int vc)
//	{
//		return m_vcs[vc]->peekTopFlit();
//	}

//	inline flit_CN* getTopFlit(int vc)
//	{
...
//	}
	inline void set_in_link(NetworkLink_CN *link)
	{
		m_in_link = link;
	}

    NetworkLink_CN * get_in_link()
	{
		return m_in_link;
	}
