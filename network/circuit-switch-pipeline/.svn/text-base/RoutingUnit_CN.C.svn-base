...
RoutingUnit_CN::RoutingUnit_CN(Router_CN *router)
{
	m_router = router;
...
void RoutingUnit_CN::addRoute(const NetDest& routing_table_entry)
{
	m_routing_table.insertAtBottom(routing_table_entry);
}

void RoutingUnit_CN::addWeight(int link_weight)
{
	m_weight_table.insertAtBottom(link_weight);
}
/*
void RoutingUnit_CN::RC_stage(flit_CN *t_flit, InputUnit_CN *in_unit, int invc)
{
...
*/
int RoutingUnit_CN::routeCompute(flit_CN *t_flit)
{
