...
*/
/* 
 * NetworkInterface_I.h
 *
 * Niket Agarwal, Princeton University
 *
 * */

#ifndef NET_INTERFACE_I_H
#define NET_INTERFACE_I_H
...
class NetworkInterface_I : public Consumer {
public:
	NetworkInterface_I(int id, int virtual_networks, IdealNetwork* network_ptr);
    ...
    flitBuffer_I *inNetBuffer;

    map<int, int> NICounters;

private:
/**************Data Members*************/
	IdealNetwork *m_net_ptr;
	int m_virtual_networks, m_num_vcs, m_vc_per_vnet;
	NodeID m_id;
	//Vector<OutVcState_d *> m_out_vc_state;
	Vector<int > m_vc_allocator;
	int m_vc_round_robin; // For round robin scheduling
	flitBuffer_I *outSrcQueue; // For modelling link contention
	flitBuffer_I *creditQueue;
	...
	// Input Flit Buffers
	Vector<flitBuffer_I *>   m_ni_buffers; // The flit buffers which will serve the Consumer
