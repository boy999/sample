...
class flit_I {
public:
	flit_I(int id, int vc, int vnet, int size, MsgPtr msg_ptr);
	flit_I(int vc, bool is_free_signal);
...
inline extern bool node_less_then_eq(flit_I* n1, flit_I* n2);

inline extern
bool node_less_then_eq(flit_I* n1, flit_I* n2)
{
...
ostream& operator<<(ostream& out, const flit_I& obj);
