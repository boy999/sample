...
#ifndef IDEALNETWORK_H
#define IDEALNETWORK_H
...
class IdealNetwork : public Network{
    public:
        ...
        inline void increment_ideal_latency(Time latency)
        {
            m_ideal_latency += latency;
        }
        ...
        Vector<NetworkInterface_I *> m_ni_ptr_vector;	// All NI's in Network

    private:
        void checkNetworkAllocation(NodeID id, bool ordered, int network_num);

        // Private copy constructor and assignment operator
        IdealNetwork(const IdealNetwork& obj);
        IdealNetwork& operator=(const IdealNetwork& obj);

        /***********Data Members*************/
        int m_virtual_networks; 
        int m_nodes;
        int m_flits_recieved, m_flits_injected;
        double m_network_latency, m_queueing_latency, m_ideal_latency;
        ...
        //Vector<NetworkLink_I *> m_link_ptr_vector; // All links in the network	
...
ostream& operator<<(ostream& out, const IdealNetwork& obj);
